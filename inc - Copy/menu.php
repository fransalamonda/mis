...
<!--                <li class="dropdown <?php if($_SESSION["menu"] == "home"){?>active<?php }?>">
                ...
                <li class="dropdown <?php if(in_array($_SESSION['menu'],$ds_array)){echo"active";}?>">
                    ...
                    <ul class="dropdown-menu">
                        <?php  if(isset($object) && ($object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4 || $object->group_id == 5)){ // production admin ?>
                        ...
                        <li <?php if($_SESSION["menu"] == "schedulemanual"){?>class="active" <?php }?>><a href="schedulemanual.php" title="Memasukkan data delivery schedule ke DEC">Add Schedule</a></li> 
                            <?php  }?>	
							  <?php  if(isset($object) && ($object->group_id == 4 ||$object->group_id == 1||$object->group_id == 2 || $object->group_id == 5|| $object->group_id == 6|| $object->group_id == 7)){ // production admin ?>
                        <li <?php if($_SESSION["menu"] == "schedulemanual"){?>class="active" <?php }?>><a href="list_delivery_schedule.php" title="List Delivery Schedule">List</a></li> 
                            <?php  }?>
							  <?php  if(isset($object) && ($object->group_id == 4 || $object->group_id == 5|| $object->group_id == 6)){ // production admin ?>
                        <li <?php if($_SESSION["menu"] == "schedulemanual"){?>class="active" <?php }?>><a href="bom.php?menu=batch_reques_adjustment_not" title="Batch Reques Adjustment">Batch Reques Adjustment</a></li> 
                            <?php  }?>
                    </ul>
                </li>
                <?php }?> <?php
                ...
                <li class="dropdown <?php if(in_array($_SESSION['menu'],$bt_array)){echo"active";}?>">
                    ...
                    <ul class="dropdown-menu">
                        <?php
                        if(isset($object) && ($object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4 || $object->group_id == 6 || $object->group_id == 5 )){ // production admin
                        ?>
                    <!--    <li><a href="upload_batch_transaction.php" title="Split file into  docket and material issue">Split File</a></li> -->
                        ...
                        <li <?php if($_SESSION["menu"] == "full_export_akumulasi"){?>class="active" <?php }?>><a href="<?php echo BASE_URL?>bom.php?menu=export_akumulasi" title="Export full batch transaction report akumulasi">Export Full Akumulasi</a></li>   
                        <?php } ?>
                         <?php
                        ...
                        <li <?php if($_SESSION["menu"] == "download"){?>class="active" <?php }?>><a href="<?php echo BASE_URL?>bom.php?menu=exsport_csv" title="Download Docket & Material Issue">Download</a></li>
                         <?php } ?>
                        <?php
                        if(isset($object) && ($object->group_id == 2||$object->group_id == 3||$object->group_id == 1||$object->group_id == 4||$object->group_id ==5 ||$object->group_id == 6 ||$object->group_id ==7)){ // production admin
                        ?>
                      <li <?php if($_SESSION["menu"] == "list_data_so"){?>class="active" <?php }?>><a href="batch_transaction_so.php" title="List batch transaction Per SO">List Data SO</a></li>
                        ...
                        <?php } ?>
                        <?php
                        if(isset($object) && ( $object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4)){ // production admin
                        ?>
                ...
                ?>
                <?php if(isset($object) && ($object->group_id == 1 || $object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4  || $object->group_id == 6 || $object->group_id == 7)){  ?>
                <li class="dropdown <?php if(in_array($_SESSION['menu'],$bom_array)){echo"active";}?>">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo BASE_URL?>bom.php?menu=mix_list">Mix Design</a></li>				
                        <?php
						 if(isset($object) && ($object->group_id==1 || $object->group_id==3 || $object->group_id==4|| $object->group_id==6)){
                        ?>
                       <li><a href="<?php echo BASE_URL?>bom.php?menu=transfer" title="List variance Mix Code">Transfer BOM</a></li> 
                        <?php
                        }
                        if(isset($object) && ($object->group_id==1 || $object->group_id==4)){
                        ?>
                        <li><a href="<?php echo BASE_URL?>bom.php" title="Memasukkan data mix design">Upload Mix Design</a></li>
                        <?php
                        }
                        ?>
                    </ul>
