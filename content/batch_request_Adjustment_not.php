             ...
             <div class="row">
                ...
                <div class="tabbable tabbable-custom boxless tabbable-reversed">
                     <div class="col-sm-4 colsm-offset-5">    
                        <div class="panel panel-primary">
                            ...
                            <div class="form-group">
                                        <label class="col-md-6 control-label" for="textinput">SEMEN A:</label>  
                                        <div class="col-md-6">
                                            <input type="text"  id="semen_a" value="" name="semen_a" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">
                                        </div>
                            </div>
                            <div class="form-group">
                                        <label class="col-md-6 control-label" for="textinput">SEMEN B:</label>  
                                        <div class="col-md-6">
                                            <input type="text"  id="semen_b" value="" name="semen_b" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">
                                        </div>
                            </div>
                            <div class="form-group">
                                        <label class="col-md-6 control-label" for="textinput">SEMEN C :</label>  
                                        <div class="col-md-6">
                                            <input type="text"  id="semen_c" value="" name="semen_c" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">
                                        </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="tabbable tabbable-custom boxless tabbable-reversed">
                     <div class="col-sm-4 colsm-offset-6">    
                        <div class="panel panel-primary">
            <div class="form-group">
                        <label class="col-md-6 control-label" for="textinput">PLAST 83 AM :</label>  
                        <div class="col-md-6">
                            <input id="plast83am" value="" name="plast83am" type="text" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">                                
                        </div>
            </div>
            <div class="form-group">
                        <label class="col-md-6 control-label" for="textinput">STEEL AGG1:</label>  
                        <div class="col-md-6">
                            <input id="steelAGG1" value="" name="steelAGG1" type="text" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">
                        </div>
            </div>
			<div class="form-group">
             ...
             <div class="form-group">
                        <label class="col-md-6 control-label" for="textinput">B SAND :</label>  
                        <div class="col-md-6">
                            <input id="Bsand" value="" name="Bsand" type="text" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">                                                                
                        </div>
            </div>
            <div class="form-group">
    ...
    <div class="tabbable tabbable-custom boxless tabbable-reversed">
         <div class="col-sm-4 colsm-offset-6">    
             <div class="panel panel-primary">
                ...
                <div class="form-group">
                        <label class="col-md-6 control-label" for="textinput">V SAND :</label>  
                        <div class="col-md-6">
                            <input id="Vsand" value="" name="Vsand" type="text" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">                                
                        </div>
                </div>
                <div class="form-group">
                        <label class="col-md-6 control-label" for="textinput">VIS 5002 :</label>  
                        <div class="col-md-6">
                            <input id="vis5002" value="" name="vis5002" type="text" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">
                        </div>
                </div>
                ...
                <div class="form-group">
                        <label class="col-md-6 control-label" for="textinput">VIS 8097 SV :</label>  
                        <div class="col-md-6">
                            <input id="vis8097sv" value="" name="vis8097sv" type="text" placeholder="" class="form-control input-md" onkeypress="return isNumberKey(event)">                                                                
                        </div>
                 </div>
              </div>
         </div>
