...
if(IS_AJAX){
    try {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($_POST['plast83am'] > 9999){ throw new Exception("Max Qty PLAST 83 AM 9999!"); }
            ...
            if($_POST['vis5002']   > 9999){ throw new Exception("Max Qty VIS 5002 9999!"); }
            ...
            if(isset($_POST['so_no']) && !empty($_POST['so_no']) && isset($_POST['docket_no']) && !empty($_POST['docket_no']) && 
              isset($_POST['plant_id']) && !empty($_POST['plant_id']) && isset($_POST['fa']) && isset($_POST['semen_a']) && isset($_POST['semen_b']) && isset($_POST['semen_c'])  &&
              ...
              isset($_POST['stonedust']) && isset($_POST['stonedustvas']) && isset($_POST['plast83am']) && isset($_POST['steelAGG1']) &&
              isset($_POST['flbrpf34']) && isset($_POST['Vsand']) && isset($_POST['vis5002']) && isset($_POST['genr8212']) && 
              isset($_POST['get702']) && isset($_POST['genb1714']) && isset($_POST['Bsand']) && isset($_POST['gencb10']) &&
              isset($_POST['flbnf15']) && isset($_POST['vis8097sv']) && isset($_POST['sbtconm']) && isset($_POST['sbtjm9']) && 
...
//                        $//cust_name = "";
                        ...
                        if(mysqli_num_rows($hasil_mix) == 0){
                            ...
                            $insertsemen_c = "INSERT INTO `mix_design_composition`(`mch_code`,`product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,`mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES ('".PLANT_ID."','ADJUSTMENT','Cement','','0000-100019','SEMEN C','".$semen_c."','0','KG','I')";
                             if(!mysqli_query($conns,$insertsemen_c)){
                                    throw new Exception('Error004 : Gagal Menambahkan Semen C,   '.mysqli_error());
                                }
                            ...
                            $insertstonedustvas = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,       `mix_qty_adj`,`unit`,`flag_code`)"
                             ...
                             $insertplast83am = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,       `mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES('".PLANT_ID."','ADJUSTMENT','Admixture','','0002-100015','plast83am','".$plast83am."','0','KG','I')";
                             ...
                             if(!mysqli_query($conns,$insertBsand)){
                                    throw new Exception('Error011 : Gagal Menambahkan Bsand,   '.mysqli_error());
                                }
                            ...
                            $insertVis5002 = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,       `mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES('".PLANT_ID."','ADJUSTMENT','Admixture','','0002-100466','vis5002','".$vis5002."','0','KG','I')";
                            if(!mysqli_query($conns,$insertvis5002)){
                                    throw new Exception('Error014 : Gagal Menambahkan vis5002,   '.mysqli_error());
                                }
                            ...
                            $insertvis8097sv = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,       `mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES('".PLANT_ID."','ADJUSTMENT','Admixture','','0002-100467','vis8097sv','".$vis8097sv."','0','KG','I')";
...
//                            echo  $UPDATEFA;                            exit();            
                            ...
                            $UPDATEplast83am = "UPDATE `mix_design_composition`
                             ...
                             if(!mysqli_query($conns,$UPDATEplast83am)){
                                    throw new Exception('Error003 : Failed Update PLAST 83 AM,  '.mysqli_error());
                                }
