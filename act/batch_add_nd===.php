...
if(IS_AJAX){
    try {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($_POST['semenc'] > 9999){ throw new Exception("Max Qty SEMEN C 9999!"); }            
           ...
           //    isset($_POST['flbrpf34']) && isset($_POST['p83']) && isset($_POST['genr8212']) && isset($_POST['get702']) && 
           //    isset($_POST['genb1714']) &&  isset($_POST['vis3660lr']) && isset($_POST['SIKAMENT183']) && isset($_POST['gencb10']) &&
           //    isset($_POST['flbnf15']) && isset($_POST['flbpd19']) && isset($_POST['sbtconm']) && isset($_POST['sbtjm9']) && 
           //    isset($_POST['sbtpca8s']) && isset($_POST['stldust']) && isset($_POST['seal_no']) && !empty($_POST['seal_no'])){
           //  extract($_POST); 
            ...
            if(isset($_POST['so_no']) && !empty($_POST['so_no']) && isset($_POST['docket_no']) && !empty($_POST['docket_no']) && 
              ...
              isset($_POST['agg3']) && isset($_POST['agg1vas']) && isset($_POST['agg2vas']) && isset($_POST['agg3vas']) && 
              isset($_POST['msand']) && isset($_POST['sand']) && isset($_POST['sandvas']) && isset($_POST['water']) && 
              isset($_POST['stonedust']) && isset($_POST['stonedustvas']) && isset($_POST['rt6p']) && isset($_POST['semenc']) &&
