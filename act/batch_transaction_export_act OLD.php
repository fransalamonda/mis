...
if( isset($_POST['filter']) && !empty($_POST['filter'])){  
    ...
    $query_select = "SELECT A.*,B.slump_code,B.description,C.process_code,C.received_vol, C.remarks,D.`desc` "
                    ...
                    . "WHERE A.`delv_date` = '".$_POST['filter']."' "
...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('CW3', "0000-100018");
        $excel->getActiveSheet()->setCellValue('CW4', "SEMEN PCC");
        ...
        $excel->getActiveSheet()->setCellValue('CZ3', "0002-100001");
        $excel->getActiveSheet()->setCellValue('CZ4', "P121R");
        ...
        $excel->getActiveSheet()->setCellValue('DC3', "0002-100409");
        $excel->getActiveSheet()->setCellValue('DC4', "SK163");
        $excel->getActiveSheet()->setCellValue('DD3', "0002-100410");
        $excel->getActiveSheet()->setCellValue('DD4', "SIKATARD930");
        $excel->getActiveSheet()->setCellValue('DE3', "0002-100402");
        $excel->getActiveSheet()->setCellValue('DE4', "VIS 1003");
        $excel->getActiveSheet()->setCellValue('DF3', "0002-100407");
        $excel->getActiveSheet()->setCellValue('DF4', "VIS 1221R");
        $excel->getActiveSheet()->setCellValue('DG3', "0002-100416");
        $excel->getActiveSheet()->setCellValue('DG4', "VIS 7080P");
        $excel->getActiveSheet()->setCellValue('DH3', "0002-100010");
        $excel->getActiveSheet()->setCellValue('DH4', "SR3200");
        $excel->getActiveSheet()->setCellValue('DI3', "0002-100403");
        $excel->getActiveSheet()->setCellValue('DI4', "V3115N");
        $excel->getActiveSheet()->setCellValue('DJ3', "0002-100432");
        $excel->getActiveSheet()->setCellValue('DJ4', "VISCO8300");
        ...
        $excel->getActiveSheet()->setCellValue('DN3', "0002-100436");
        $excel->getActiveSheet()->setCellValue('DN4', "ACE8381");
...
//        $excel->getActiveSheet()->mergeCells('BV4:BV4');
        ...
        $excel->getActiveSheet()->getStyle('A5:DZ5')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D17DEAE');
        ...
        while($obj = $result->fetch_object()){
                ...
                $tar_total_flbpd19 = 0;
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    if($obj_total->material_code == "0000-100094"){ //sand / pasir
                        ...
                        $excel->getActiveSheet()->setCellValue('AW5', $tar_total_sand);
                    }
                    elseif($obj_total->material_code == "0000-100089"){ //MSand
                        ...
                        $excel->getActiveSheet()->setCellValue('AX5', $tar_total_msand);
                    }
                     elseif($obj_total->material_code == "0000-100093"){ // STONEDUST 
                        ...
                        $excel->getActiveSheet()->setCellValue('Q5', $act_total_stonedust);
                        $excel->getActiveSheet()->setCellValue('AY5', $tar_total_stonedust);
                    }
                    elseif($obj_total->material_code == "0000-100090"){ //AGG1 
                        $act_total_agg1+=$obj_total->actual_qty;
                        $tar_total_agg1+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('R5', $act_total_agg1);
                        $excel->getActiveSheet()->setCellValue('AZ5', $tar_total_agg1);
                    }
                    elseif($obj_total->material_code == "0000-100091"){ //AGG2
                        $act_total_agg2+=$obj_total->actual_qty;
                        $tar_total_agg2+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('S5', $act_total_agg2);
                        $excel->getActiveSheet()->setCellValue('BA5', $tar_total_agg2);
                    }
                    elseif($obj_total->material_code == "0000-100092"){ //AGG3
                     ...
                     elseif($obj_total->material_code == "0000-100038"){ //AGG5 
                        ...
                        $excel->getActiveSheet()->setCellValue('U5', $act_total_AGG5);
                        $excel->getActiveSheet()->setCellValue('BC5', $tar_total_AGG5);
                    } 
                     elseif($obj_total->material_code == "0000-100039"){ //AGG6
                        $act_total_agg6+=$obj_total->actual_qty;
                        $tar_total_agg6+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('V5', $act_total_agg6);
                        $excel->getActiveSheet()->setCellValue('BD5', $tar_total_agg6);
                    } 
                    elseif($obj_total->material_code == "0000-100011"){ //Cementtp1  
                        ...
                        $excel->getActiveSheet()->setCellValue('W5', $act_total_cementtp1);
                        $excel->getActiveSheet()->setCellValue('BE5', $tar_total_cementtp1);
                    }
                    elseif($obj_total->material_code == "0000-100017"){ //Cementtp2  
                        ...
                        $excel->getActiveSheet()->setCellValue('X5', $act_total_cementtp2);
                        $excel->getActiveSheet()->setCellValue('BF5', $tar_total_cementtp2);
                    }
                    elseif($obj_total->material_code == "0000-100018"){ //Cementpcc  
                        ...
                        $excel->getActiveSheet()->setCellValue('Y5', $act_total_cementpcc);
                        $excel->getActiveSheet()->setCellValue('BG5', $tar_total_cementpcc);
                    }
                    elseif($obj_total->material_code == "0000-000015"){ //Flying Ash
                        $act_total_fa+= $obj_total->actual_qty;
                        $tar_total_fa+= $obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('Z5', $act_total_fa);
                        $excel->getActiveSheet()->setCellValue('BH5', $tar_total_fa);
                    }
                    elseif($obj_total->material_code == "0000-100030"){ // water / Air 
                        ...
                        $excel->getActiveSheet()->setCellValue('AA5', $act_total_water);
                        $excel->getActiveSheet()->setCellValue('BI5', $tar_total_water);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100001"){ //P 121 R 
                        ...
                        $excel->getActiveSheet()->setCellValue('AB5', $act_total_P121R);
                        $excel->getActiveSheet()->setCellValue('BJ5', $tar_total_P121R);
                    }
                    elseif($obj_total->material_code == "0002-100201"){ //523 N 
                        $act_total_s523n+=$obj_total->actual_qty;
                        $tar_total_s523n+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('AC5', $act_total_s523n);
                        $excel->getActiveSheet()->setCellValue('BK5', $tar_total_s523n);
                    }
                    elseif($obj_total->material_code == "0002-100006"){ //RT6P
                        $act_total_rt6p+=$obj_total->actual_qty;
                        $tar_total_rt6p+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('AD5', $act_total_rt6p);
                        $excel->getActiveSheet()->setCellValue('BL5', $tar_total_rt6p);
                    }
                    elseif($obj_total->material_code == "0002-100409"){ //SK163
                        $act_total_sk163+=$obj_total->actual_qty;
                        $tar_total_sk163+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('AE5', $act_total_sk163);
                        $excel->getActiveSheet()->setCellValue('BM5', $tar_total_sk163);
                    }
                    elseif($obj_total->material_code == "0002-100410"){ //SK930
                        $act_total_sk930+=$obj_total->actual_qty;
                        $tar_total_sk930+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('AF5', $act_total_sk930);
                        $excel->getActiveSheet()->setCellValue('BN5', $tar_total_sk930);
                    }
                    elseif($obj_total->material_code == "0002-100402"){ //VIS 1003 
                        ...
                        $excel->getActiveSheet()->setCellValue('AG5', $act_total_vis1003);
                        $excel->getActiveSheet()->setCellValue('BO5', $tar_total_vis1003);
                    }
                    elseif($obj_total->material_code == "0002-100407"){ //VIS 1212R
                        ...
                        $excel->getActiveSheet()->setCellValue('AH5', $act_total_vis1212r);
                        $excel->getActiveSheet()->setCellValue('BP5', $tar_total_vis1212r);
                    }
                    elseif($obj_total->material_code == "0002-100416"){ //VIS 7080p 
                        ...
                        $excel->getActiveSheet()->setCellValue('AI5', $act_total_vis7080p);
                        $excel->getActiveSheet()->setCellValue('BQ5', $tar_total_vis7080p);
                    }
                    elseif($obj_total->material_code == "0002-100010"){ //SR 3200
                        ...
                        $excel->getActiveSheet()->setCellValue('AJ5', $act_total_sr3200);
                        $excel->getActiveSheet()->setCellValue('BR5', $tar_total_sr3200);
                    }    
                    ...
                    elseif($obj_total->material_code == "0002-100403"){ //V3115N 
                        ...
                        $excel->getActiveSheet()->setCellValue('AK5', $act_total_V3115N);
                        $excel->getActiveSheet()->setCellValue('BS5', $tar_total_V3115N);
                    }                        
                    elseif($obj_total->material_code == "0002-100432"){ //VISCO 8300 
                        ...
                        $excel->getActiveSheet()->setCellValue('AL5', $act_total_visco8300);
                        $excel->getActiveSheet()->setCellValue('BT5', $tar_total_visco8300);
                    }        
                    elseif($obj_total->material_code == "0002-100015"){ //P83 
                        $act_total_P83+=$obj_total->actual_qty;
                        $tar_total_P83+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('AM5', $act_total_P83);
                        $excel->getActiveSheet()->setCellValue('BU5', $tar_total_P83);
                    }              
                    elseif($obj_total->material_code == "0002-100017"){ //MAST 1100 
                        ...
                        $excel->getActiveSheet()->setCellValue('AN5', $act_total_SIKAMENT183);
                        $excel->getActiveSheet()->setCellValue('BV5', $tar_total_SIKAMENT183);
                    }    
                    elseif($obj_total->material_code == "0002-100435"){ //MAST 1007 
                        $act_total_mast1007+=$obj_total->actual_qty;
                        $tar_total_mast1007+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('AO5', $act_total_mast1007);
                        $excel->getActiveSheet()->setCellValue('BW5', $tar_total_mast1007);
                    }          
                    elseif($obj_total->material_code == "0002-100436"){ //ACE 8381 
                        ...
                        $excel->getActiveSheet()->setCellValue('AP5', $act_total_ace8381);
                        $excel->getActiveSheet()->setCellValue('BX5', $tar_total_ace8381);
                    }    
                    elseif($obj_total->material_code == "0002-100437"){ //GENR 8212
                        ...
                        $excel->getActiveSheet()->setCellValue('AQ5', $act_total_genr8212);
                        $excel->getActiveSheet()->setCellValue('BY5', $tar_total_genr8212);
                    }       
                    elseif($obj_total->material_code == "0002-100438"){ //GET 702
                        ...
                        $excel->getActiveSheet()->setCellValue('AR5', $act_total_get702);
                        $excel->getActiveSheet()->setCellValue('BZ5', $tar_total_get702);
                    }           
                    elseif($obj_total->material_code == "0002-100439"){ //GENB 1714
                        ...
                        $excel->getActiveSheet()->setCellValue('AS5', $act_total_genb1714);
                        $excel->getActiveSheet()->setCellValue('CA5', $tar_total_genb1714);
                    }    
                     elseif($obj_total->material_code == "0002-100430"){ //vis3660lr 
                        ...
                        $excel->getActiveSheet()->setCellValue('AT5', $act_total_vis3660lr);
                        $excel->getActiveSheet()->setCellValue('CB5', $tar_total_vis3660lr);
                    } 
                      elseif($obj_total->material_code == "0002-100440"){ //flbnf15
                        ...
                        $excel->getActiveSheet()->setCellValue('AU5', $act_total_flbnf15);
                        $excel->getActiveSheet()->setCellValue('CC5', $tar_total_flbnf15);
                    }    
                     elseif($obj_total->material_code == "0002-100441"){ //flbpd19
                        ...
                        $excel->getActiveSheet()->setCellValue('AV5', $act_total_flbpd19);
                        $excel->getActiveSheet()->setCellValue('CD5', $tar_total_flbpd19);
                    }                              
                }
            ...
            if($result_detail = $mysqli->query($query_select_detail)){
               ...
               if($act_qty_fa+$act_qty_cementtp1==0){$fa_percentage=0;}
                ...
                $excel->getActiveSheet()->setCellValue("CW".$row, round($var_cementpcc,2));
                ...
                if($tar_qty_P121R === 0){
                  //  $var_P121R = 0;
                    ...
                    $excel->getActiveSheet()->setCellValue("CZ".$row, round($var_P121R,2));
                }
                if($tar_qty_s523n === 0){
                    //$var_s523n = 0;
                ...
                if($tar_qty_sk163 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("DC".$row, round($var_sk163,2));
                }
                //sk930
                if($tar_qty_sk930 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("DD".$row, round($var_sk930,2));
                }
                //vis1003
                ...
                if($tar_qty_vis1212r === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("DF".$row, round($var_vis1212r,2));
                }
                ...
                if($tar_qty_vis7080p === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("DG".$row, round($var_vis7080p,2));
                }
                //var_sr3200
                if($tar_qty_sr3200 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("DH".$row, round($var_sr3200,2));
                }
                 //var_vis3660lr
                 ...
                 if($tar_qty_V3115N === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("DI".$row, round($var_V3115N,2));
                }
                 //var_visco8300
                 if($tar_qty_visco8300 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("DJ".$row, round($var_visco8300,2));
                }
                //var_P83
                if($tar_qty_P83 === 0){ 
                ...
                if($tar_qty_ace8381 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("DN".$row, round($var_ace8381,2));
                }
                //var_genr8212
