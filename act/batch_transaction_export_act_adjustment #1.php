...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->setCellValue('AG3', "0000-100040");
        $excel->getActiveSheet()->setCellValue('AG4', "STEEL AGG1");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('BD3', "0000-100038");
        $excel->getActiveSheet()->setCellValue('BD4', "SEMEN B");
        $excel->getActiveSheet()->setCellValue('BE3', "0000-000029");
        ...
        $excel->getActiveSheet()->setCellValue('BP3', "0000-100040");
        $excel->getActiveSheet()->setCellValue('BP4', "STEEL AGG1");
        ...
        $excel->getActiveSheet()->setCellValue('BV3', "0002-100015");
        $excel->getActiveSheet()->setCellValue('BV4', "P83");
        $excel->getActiveSheet()->setCellValue('BW3', "0002-100017");
        $excel->getActiveSheet()->setCellValue('BW4', "SIKAMENT183");
        $excel->getActiveSheet()->setCellValue('BX3', "0002-100435");
        $excel->getActiveSheet()->setCellValue('BX4', "MAST1007");
        ...
        $excel->getActiveSheet()->setCellValue('CC3', "0002-100430");
        $excel->getActiveSheet()->setCellValue('CC4', "VIS3660LR");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->getStyle('Gg2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->setCellValue('DC3', "0002-100201");
        $excel->getActiveSheet()->setCellValue('DC4', "S523N");
        ...
        $excel->getActiveSheet()->setCellValue('DG3', "0000-100040");
        $excel->getActiveSheet()->setCellValue('DG4', "STEEL AGG1");
        ...
        $excel->getActiveSheet()->setCellValue('DL3', "0000-100062");
        $excel->getActiveSheet()->setCellValue('DL4', "STONE DUST VAS");
        $excel->getActiveSheet()->setCellValue('DM3', "0002-100015");
        $excel->getActiveSheet()->setCellValue('DM4', "P83");
        $excel->getActiveSheet()->setCellValue('DN3', "0002-100017");
        $excel->getActiveSheet()->setCellValue('DN4', "SIKAMENT183");
        $excel->getActiveSheet()->setCellValue('DO3', "0002-100435");
        $excel->getActiveSheet()->setCellValue('DO4', "MAST1007");
        ...
        $excel->getActiveSheet()->setCellValue('DT3', "0002-100430");
        $excel->getActiveSheet()->setCellValue('DT4', "VIS3660LR");
        $excel->getActiveSheet()->setCellValue('DU3', "0002-100440");
        $excel->getActiveSheet()->setCellValue('DU4', "FLBNF-15");
        $excel->getActiveSheet()->setCellValue('DV3', "0002-100441");
        $excel->getActiveSheet()->setCellValue('DV4', "FLBPD-19");
        $excel->getActiveSheet()->setCellValue('DW3', "0002-100019");
        ...
        while($obj = $result->fetch_object()){
            ...
            if($result_detail = $mysqli->query($query_select_detail)){
                ...
                while($obj_detail = $result_detail->fetch_object()){     
                    ...
                    // elseif($obj_detail->material_code == "0000-100011"){ //semen A 
                    //     $excel->getActiveSheet()->setCellValue("W".$row, $obj_detail->actual_qty);
                    //     $excel->getActiveSheet()->setCellValue("BE".$row, $obj_detail->target_qty);
                    //     $act_qty_semenA+=$obj_detail->actual_qty;
                    //     $tar_qty_semenA+=$obj_detail->target_qty;
                ...
                */
                ...
                //var_stldust
                 if($tar_qty_stldust === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("CT".$row, round($var_stldust,2));
                }
                ...
                $excel->getActiveSheet()->setCellValue("CU".$row, round($var_semenA,2));
                //sementtp2        
                ...
                if($tar_qty_stlagg1 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("DE".$row, round($var_stlagg1,2));
                }
