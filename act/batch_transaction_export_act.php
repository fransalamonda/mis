...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->setCellValue('AM4', "GCP512LN");
        $excel->getActiveSheet()->setCellValue('AN3', "0002-100027");
        $excel->getActiveSheet()->setCellValue('AN4', "FLBPF24");
        ...
        $excel->getActiveSheet()->setCellValue('AT4', "BSAND");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('BV4', "GCP512LN");
        $excel->getActiveSheet()->setCellValue('BW3', "0002-100027");
        $excel->getActiveSheet()->setCellValue('BW4', "FLBPF24");
        ...
        $excel->getActiveSheet()->setCellValue('CC4', "BSAND");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('CT3', "0002-100001");
        ...
        $excel->getActiveSheet()->setCellValue('DE4', "GCP512LN");
        $excel->getActiveSheet()->setCellValue('DF3', "0002-100027");
        $excel->getActiveSheet()->setCellValue('DF4', "FLBPF24");
        ...
        $excel->getActiveSheet()->setCellValue('DL4', "BSAND");
        ...
        $excel->getActiveSheet()->setCellValue('DN4', "VIS 8097 SV");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('EV4', "GCP512LN");
        $excel->getActiveSheet()->setCellValue('EW3', "0002-100027");
        $excel->getActiveSheet()->setCellValue('EW4', "FLBPF24");
        ...
        $excel->getActiveSheet()->setCellValue('FC4', "BSAND");
        ...
        $excel->getActiveSheet()->setCellValue('FE4', "VIS 8097 SV");
        ...
        while($obj = $result->fetch_object()){
            ...
            if($result_total = $mysqli->query($query_select_total)){
                ...
                $tar_total_vis8097sv = 0;
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    ...
                    elseif($obj_total->material_code == "0000-100040"){ //P 121 R 
                    ...
                    elseif($obj_total->material_code == "0002-100201"){ //523 N 
                        ...
                        $excel->getActiveSheet()->setCellValue('BK5', $act_total_steelagg1);
                        $excel->getActiveSheet()->setCellValue('CS5', $tar_total_steelagg1);
                    }
                    elseif($obj_total->material_code == "0002-100006"){ //RT6P
                        $act_total_rt6p+=$obj_total->actual_qty;
                        $tar_total_rt6p+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BL5', $act_total_rt6p);
                        $excel->getActiveSheet()->setCellValue('CT5', $tar_total_rt6p);
                    }
                    ...
                    elseif($obj_total->material_code == "0000-100021"){ //SEMEN C 
                        ...
                        $excel->getActiveSheet()->setCellValue('BO5', $act_total_semenC);
                        $excel->getActiveSheet()->setCellValue('CW5', $tar_total_semenC);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100028"){ //GCP P26
                        ...
                        $excel->getActiveSheet()->setCellValue('BT5', $act_total_gcpp26);
                        $excel->getActiveSheet()->setCellValue('DB5', $tar_total_gcpp26);
                    }        
                    elseif($obj_total->material_code == "0002-100006"){ //GCP512LN 
                        $act_total_GCP512LN+=$obj_total->actual_qty;
                        $tar_total_GCP512LN+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BU5', $act_total_GCP512LN);
                        $excel->getActiveSheet()->setCellValue('DC5', $tar_total_GCP512LN);
                    }              
                    elseif($obj_total->material_code == "0002-100027"){ //MAST 1100 
                        ...
                        $excel->getActiveSheet()->setCellValue('BV5', $act_total_FLBPF24);
                        $excel->getActiveSheet()->setCellValue('DD5', $tar_total_FLBPF24);
                    }    
                    ...
                    elseif($obj_total->material_code == "0002-100439"){ //GENB 1714
                     ...
                     elseif($obj_total->material_code == "0000-100098"){ //bSand 
                        $act_total_bSand+=$obj_total->actual_qty;
                        $tar_total_bSand+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('CB5', $act_total_bSand);
                        $excel->getActiveSheet()->setCellValue('DJ5', $tar_total_bSand);
                    } 
                     ...
                     elseif($obj_total->material_code == "0002-100467"){ //vis8097sv
                        ...
                        $excel->getActiveSheet()->setCellValue('CD5', $act_total_vis8097sv);
                        $excel->getActiveSheet()->setCellValue('DL5', $tar_total_vis8097sv);
                    }                              
                }
            ...
            if($result_detail = $mysqli->query($query_select_detail)){
                ...
                while($obj_detail = $result_detail->fetch_object()){     
                    ...
                    elseif($obj_detail->material_code == "0000-100040"){ //P 121 R 
                    ...
                    elseif($obj_detail->material_code == "0002-100028"){ //VISCO 8300
            ...
            while($obj1 = $result_detail1->fetch_object()){     
                    ...
                    elseif($obj1->material_code == "0000-100040"){ //P 121 R 
                    ...
                    elseif($obj1->material_code == "0002-100028"){ //VISCO 8300
                        $nor_qty_gcpp26+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AL".$row, $obj1->mix_qty);

                    }        
                    elseif($obj1->material_code == "0002-100006"){ //GCP512LN
                    ...
                    elseif($obj1->material_code == "0000-100098"){ //bSand
               ...
               if($act_qty_fa+$act_qty_cementA==0){$fa_percentage=0;}
                ...
                if($tar_qty_steelagg1 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EI".$row, round($var_steelagg1,2));
                }
                if ($tar_qty_rt6p === 0){
                ...
                if($tar_qty_semenC === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EM".$row, round($var_semenC,2));
                }
                ...
                if($tar_qty_agg3vas === 0){ 
                 ...
                 if($tar_qty_gcpp26 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("ER".$row, round($var_gcpp26,2));
                }
                //var_GCP512LN
                if($tar_qty_GCP512LN === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("ES".$row, round($var_GCP512LN,2));
                }
                //var_FLBPF24
                if($tar_qty_FLBPF24 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("ET".$row, round($var_FLBPF24,2));
                }
                //var_FLBPD14
                ...
                if($tar_qty_get702 === 0){ 
                 ...
                 if($tar_qty_vis8097sv === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("FB".$row, round($var_vis8097sv,2));
                }  
