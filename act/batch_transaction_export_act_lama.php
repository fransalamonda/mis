...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->setCellValue('AP4', "SBTPCA-8S");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('BX4', "SBTPCa-8S");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('DF4', "SBTPCA-8S");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('EV4', "SBTPCa-8S");
            ...
            if($result_total = $mysqli->query($query_select_total)){
                ...
                $tar_total_flbpd19 = 0;
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    ...
                    elseif($obj_total->material_code == "0002-100021"){ //ASBT PCA-8S
