...
if(IS_AJAX){
    try {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($_POST['cementtp1'] > 9999){ throw new Exception("Max Qty cementtp1 9999!"); }
            ...
            if($_POST['semenc'] > 9999){ throw new Exception("Max Qty semenc 9999!"); }    // SEMEN C        
            ...
            if($_POST['gencb10'] > 9999){ throw new Exception("Max Qty GENCB10 9999!"); } // GENCB 10
            ...
            if( isset($_POST['fa']) && isset($_POST['cementtp1']) && isset($_POST['cementtp2']) && isset($_POST['cementvas']) && isset($_POST['agg1']) && isset($_POST['agg2']) && isset($_POST['agg3']) && isset($_POST['agg1vas']) && isset($_POST['agg2vas']) && isset($_POST['agg3vas']) && isset($_POST['msand']) && isset($_POST['sand']) && isset($_POST['sandvas']) && isset($_POST['stonedustvas']) && isset($_POST['water']) && isset($_POST['stonedust']) && isset($_POST['rt6p']) && isset($_POST['semenc']) && isset($_POST['flbrpf34']) &&  isset($_POST['vis3660lr']) && isset($_POST['gencb10']) && isset($_POST['sbtconm']) && isset($_POST['sbtjm9']) && isset($_POST['sbtpca8s']) && isset($_POST['p83']) && isset($_POST['SIKAMENT183']) && isset($_POST['genr8212']) && isset($_POST['get702']) && isset($_POST['stldust']) && isset($_POST['flbnf15']) && isset($_POST['flbpd19']) && isset($_POST['genb1714']) ){
            extract($_POST); 

            if($fa == '' ){ $fa='0'; }
            if($cementtp1 == ''){ $cementtp1 = '0'; }    
            ...
            if($rt6p == ''){ $rt6p = '0'; } 
            if($semenc == ''){ $semenc = '0'; }  // SEMEN C
            if($flbrpf34 == ''){$flbrpf34 = '0'; }                            
            if($vis3660lr == ''){ $vis3660lr = '0'; }
            if($gencb10 == ''){ $gencb10 = '0'; }  // GENCB 10
...
//                             $pd = 'ADJ1';                            
                             ...
                             $insertcementtp1 = "INSERT INTO `mix_design_composition`(`mch_code`,`product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,`mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES ('".PLANT_ID."','SELFUSAGE','Cement','','0000-100011','SEMEN OPC TYPE 1','".$cementtp1."','0','KG','I')";
                             if(!mysqli_query($conns,$insertcementtp1)){
                            ...
                            $insertstonedustvas = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,       `mix_qty_adj`,`unit`,`flag_code`)"
                             ...
                             if(!mysqli_query($conns,$insertRT6P)){
								...
								// SEMEN C
                             $insertsemenc = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,       `mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES('".PLANT_ID."','SELFUSAGE','Cement','','0000-100021','SEMEN C','".$semenc."','0','KG','I')";
                             if(!mysqli_query($conns,$insertsemenc)){
                                    throw new Exception('Error017 : Gagal Menambahkan SEMEN C,   '.mysqli_error());
                                }
                            ...
                            $insertgencb10 = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,       `mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES('".PLANT_ID."','SELFUSAGE','Admixture','','0002-100023','gen cb10','".$gencb10."','0','KG','I')";
...
//                            echo  $UPDATEFA;                            exit();            
                            ...
                            $UPDATEAGG3VAS = "UPDATE `mix_design_composition`
                             ...
                             $UPDATEcementtp1 = "UPDATE `mix_design_composition`
                                    SET `mix_qty` = '".$cementtp1."'
                                    WHERE `mch_code` = '".PLANT_ID."'
                                        AND `product_code` = 'SELFUSAGE'
                                        AND `material_code` = '0000-100011'";
                            //print_r($UPDATEcement);
                             if(!mysqli_query($conns,$UPDATEcementtp1)){
                            ...
                            $UPDATErt6p = "UPDATE `mix_design_composition`
                             ...
                             if(!mysqli_query($conns,$UPDATErt6p)){
								...
								// SEMEN C
                            $UPDATEsemenc = "UPDATE `mix_design_composition`
                                    SET `mix_qty` = '".$semenc."'
                                    WHERE `mch_code` = '".PLANT_ID."'
                                        AND `product_code` = 'SELFUSAGE'
                                        AND `material_code` = '0000-100021'";
                             if(!mysqli_query($conns,$UPDATEvis1003)){
                                    throw new Exception('Error003 : Failed Update SEMEN C,  '.mysqli_error());
                                }
