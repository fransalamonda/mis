...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->getStyle('AW2:CD2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('ff9800');
        ...
        $excel->getActiveSheet()->setCellValue('BO3', "0000-100021");
        $excel->getActiveSheet()->setCellValue('BO4', "SEMEN C");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->getStyle('CE2:DL2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('c1ff4d');
        ...
        $excel->getActiveSheet()->setCellValue('CW3', "0000-100019");
        $excel->getActiveSheet()->setCellValue('CW4', "SEMEN C");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('EM3', "0000-100019");
        $excel->getActiveSheet()->setCellValue('EM4', "SEMEN C");
...
//        $excel->getActiveSheet()->mergeCells('BV4:BV4');
        ...
        $excel->getActiveSheet()->getStyle('A5:FH5')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('80ff66');
        ...
        while($obj = $result->fetch_object()){
            ...
            while($obj1 = $result_detail1->fetch_object()){     
                    ...
                    elseif($obj1->material_code == "0000-100021"){ //SEMENC
