...
if(IS_AJAX){
    try {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($_POST['semenc'] > 9999){ throw new Exception("Max Qty SEMEN C 9999!"); } // SEMEN C           
            ...
            if(isset($_POST['so_no']) && !empty($_POST['so_no']) && isset($_POST['docket_no']) && !empty($_POST['docket_no']) && 
               isset($_POST['plant_id']) && !empty($_POST['plant_id']) && isset($_POST['fa']) && isset($_POST['cementtp1']) &&  
               ...
               isset($_POST['rt6p']) && isset($_POST['semenc'])&& isset($_POST['gencb10']) && isset($_POST['flbrpf34']) && 
               isset($_POST['vis3660lr']) && isset($_POST['p83'])&& isset($_POST['SIKAMENT183']) && isset($_POST['genr8212']) && 
                ...
                if(mysqli_num_rows($hasil_mix) == 0){
                    ...
                    if(!mysqli_query($conns,$insertMD)){throw new Exception('Error002 : Gagal Menambahkan mix_design,   '.mysqli_error());}
                             ...
                             $insertcementtp1 = "INSERT INTO `mix_design_composition`(`mch_code`,`product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,`mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES ('".PLANT_ID."','ADJUSTMENT','Cement','','0000-100011','SEMEN OPC TYPE 1','".$cementtp1."','0','KG','I')";
                            ...
                            $insertAGG1vas = "INSERT INTO `mix_design_composition`(`mch_code`,`product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,`mix_qty_adj`,`unit`,`flag_code`)"
                             ...
                             if(!mysqli_query($conns,$insertRT6P)){
								 ...
								 // SEMEN C
                             $insertSEMEN C = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,`mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES('".PLANT_ID."','ADJUSTMENT','Cement','','0000-100021','SEMEN C','".$semenc."','0','KG','I')";
                             if(!mysqli_query($conns,$insertSEMEN C)){
                            ...
                            $insertgencb10 = "INSERT INTO `mix_design_composition`(`mch_code`,    `product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,`mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES('".PLANT_ID."','ADJUSTMENT','Admixture','','0002-100023','gencb10','".$gencb10."','0','KG','I')";
                            ...
                            if(!mysqli_query($conns,$insertp83)){
                                    throw new Exception('Error019 : Gagal Menambahkan p83,   '.mysqli_error());
                                }
                            ...
                            if(!mysqli_query($conns,$insertvis3660lr)){
                                    throw new Exception('Error024 : Gagal Menambahkan vis3660lr,   '.mysqli_error());
                                }
                        ...
                        if(mysqli_num_rows($hasil_mix) > 0){
                            ...
                            $UPDATEsemenc = "UPDATE `mix_design_composition`
                             ...
                             if(!mysqli_query($conns,$UPDATEsemenc)){
