...
if(IS_AJAX){
    try {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if( isset($_POST['fa']) && isset($_POST['semen_a']) && isset($_POST['semen_b']) && isset($_POST['semen_c']) && isset($_POST['cementtp2']) && isset($_POST['cementvas']) && isset($_POST['agg1']) && isset($_POST['agg2']) && isset($_POST['agg3']) && isset($_POST['agg1vas']) && isset($_POST['agg2vas']) && isset($_POST['agg3vas']) && isset($_POST['msand']) && isset($_POST['sand']) && isset($_POST['sandvas']) && isset($_POST['stonedustvas']) && isset($_POST['water']) && isset($_POST['stonedust']) && isset($_POST['rt6p']) && isset($_POST['steelAGG1']) && isset($_POST['flbrpf34']) &&  isset($_POST['Bsand']) && isset($_POST['gencb10']) && isset($_POST['sbtconm']) && isset($_POST['sbtjm9']) && isset($_POST['sbtpca8s']) && isset($_POST['Vsand']) && isset($_POST['SIKAMENT183']) && isset($_POST['genr8212']) && isset($_POST['get702']) && isset($_POST['stldust']) && isset($_POST['flbnf15']) && isset($_POST['flbpd19']) && isset($_POST['genb1714']) ){
            extract($_POST); 
...
//                             $pd = 'ADJ1';                            
                            ...
                            $insertsemen_c = "INSERT INTO `mix_design_composition`(`mch_code`,`product_code`,`material_group`,`seq_no`,`material_code`,`material_name`,`mix_qty`,`mix_qty_adj`,`unit`,`flag_code`)"
                                        . "VALUES ('".PLANT_ID."','SELFUSAGE','Cement','','0000-100019','SEMEN C','".$semen_c."','0','KG','I')";
