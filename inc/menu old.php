...
<!--                <li class="dropdown <?php if($_SESSION["menu"] == "home"){?>active<?php }?>">
                ...
                ?>
                <?php if(isset($object) && ($object->group_id == 1 || $object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4 || $object->group_id == 5 || $object->group_id == 6)){ // production admin ?>
                ...
                <li class="dropdown <?php if(in_array($_SESSION['menu'],$bt_array)){echo"active";}?>">
                    ...
                    <ul class="dropdown-menu">
                        <?php
                        if(isset($object) && ($object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4 || $object->group_id == 6 || $object->group_id == 5 || $object->group_id == 7  )){ // production admin
                        ?>
                ...
                ?>
                <?php if(isset($object) && ($object->group_id == 1 || $object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4  || $object->group_id == 6)){  ?>
                ...
                if(isset($_SESSION['login'])){
                    if(isset($object) && $object->group_id == 4){ // administrator
                ?>
                <?php
                //mengatur css active pada menu batch transaction
