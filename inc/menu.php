<div thead align="center" style="background-color:white;color:red;">
    <font>
        <h3>
            <td width="400px"> <img src="images/mpb1.jpg" width="120px" height="100px" /> <strong> PT.MOTIVE MULIA MERAH PUTIH BETON</strong></td> | 
            <td width="400px" ><strong style="color:#00008B;">RMC Application Report</strong> 
            </td>
        </h3>
    </font>
...
<!--                <li class="dropdown <?php if($_SESSION["menu"] == "home"){?>active<?php }?>">
                ...
                <li class="dropdown <?php if(in_array($_SESSION['menu'],$ds_array)){echo"active";}?>">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle"> <i class="fa fa-bus"></i> DELIVERY SCHEDULE<b class="caret"></b></a>
				...
				<li class="dropdown <?php if(in_array($_SESSION['menu'],$bt_array)){echo"active";}?>">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-file-text"></i> BATCH TRANSACTION<b class="caret"></b></a>
                    <ul class="dropdown-menu">
					
                        <?php if(isset($object) && ($object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4 || $object->group_id == 6    )){ // production admin
                        ?>
                ...
                <li class="dropdown <?php if(in_array($_SESSION['menu'],$bom_array)){echo"active";}?>">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cubes"></i> BOM &nbsp;<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                ...
                <?php if(isset($object) && ($object->group_id == 1 || $object->group_id == 2 || $object->group_id == 3 || $object->group_id == 4 || $object->group_id == 5 || $object->group_id == 6 || $object->group_id == 7)){ ?>

                    <li class="dropdown <?php if(in_array($_SESSION['menu'],$bom_array)){echo"active";}?>">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-truck"></i> TRUCK MIXER &nbsp;<b class="caret"></b></a>
                        <ul class="dropdown-menu">

                            <li><a href="./tm.php?filter=&menu=truck_list">Driver</a></li>  
                ...
                <li class="dropdown <?php if(in_array($_SESSION['menu'],$pe_array)){echo"active";}?>" >
                    <a href="" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cogs"></i> SETTING<b class="caret"></b></a>
                    <ul class="dropdown-menu">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                if(isset($_SESSION['login'])){
                ?>
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-user"></i> <?php echo $object->username; ?><span class="caret"></span></a>
...
<!--                        <li><a href=".\content\about.php"><i class="fa fa-truck"></i>&nbsp;About</a></li>-->
                ...
                ?>
                <li><a href="login.php"><i class="fa fa-sign-in"></i>&nbsp;<h5>Login</h5></a></li>
                <?php
                }
                ?>
            </ul>
