                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-scrollable">
							...
							<th bgcolor="FFFF00">Sisa Vol Act</th>
                                                        ...
                                                        <?php
                                                        if (isset($object) && ($object->group_id == 5 || $object->group_id == 4 || $object->group_id == 6 || $object->group_id == 2 || $object->group_id == 7)) {
                                                        ?>
                                                    ...
                                                    ?>
                                                            ...
                                                            if ($row['ds_code'] == 'M') { ?>
                                                                <tr class="danger">
                                                                    ...
                                                                    <?php if (isset($object) && ($object->group_id == 5 || $object->group_id == 4 || $object->group_id == 6 || $object->group_id == 2 || $object->group_id == 1 || $object->group_id == 7)) { ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php if ($row['out_volume'] == 0) { ?>
                                                                    ...
                                                                    <?php if (isset($object) && ($object->group_id == 4)) { ?>
                                                                     ...
                                                                     <?php } else if (isset($object) && ($object->group_id == 2 || $object->group_id == 6)) { ?>
                                                                        ...
                                                                        <?php } else if (isset($object) && ($object->group_id == 1 || $object->group_id == 7 )) { ?>
                                                                            <td><a href="viewschedule.php?id=<?= $row['id']; ?>" style="color:#48D1CC;">View</a></td>
                                                                    <?php } else {
