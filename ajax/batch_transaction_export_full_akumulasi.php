 ...
 * revisi 2 181222 by FSM : add reaport obat agg3vas
 */
...
if( isset($_GET['filter']) && !empty($_GET['filter'])){  
    ...
    $output_name = $_GET['filter'].date("His")."_".PLANT_ID."_produk.xls";
...
//    echo $query_select;exit();
    if ($result = $mysqli->query($query_select)) {
        ...
        $excel->getActiveSheet()->setCellValue('A1', "BATCH TRANSACTION AKUMULASI FULL REPORT( ".$ymd." )");
        //change the font size
        $excel->getActiveSheet()->getStyle('A1')->getFont()->setSize(20);        
        //merge cell A1 until FH1
       $excel->getActiveSheet()->mergeCells('A1:FL1');
        ...
        $excel->getActiveSheet()->getStyle('A2:FL4')->applyFromArray($styleArray);
        //make the font become bold
        $excel->getActiveSheet()->getStyle('A1:FL4')->getFont()->setBold(true);
        //HEADER
...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->getStyle('O2:AW2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('FFFF00');
        ...
        $excel->getActiveSheet()->setCellValue('AD3', "0002-100030");
        $excel->getActiveSheet()->setCellValue('AD4', "LIQUID CO2");
        ...
        $excel->getActiveSheet()->setCellValue('AI3', "0002-100064");
        ...
        $excel->getActiveSheet()->setCellValue('AV4', "VIS 8097SV");
       ...
       //0002-100010
        ...
        //ACTUAL QTY
        $excel->getActiveSheet()->setCellValue('AX2', "Actual Qty");
        ...
        $excel->getActiveSheet()->getStyle('AX2:CF2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('E8D0A9');
        ...
        $excel->getActiveSheet()->setCellValue('BM3', "0002-100030");
        $excel->getActiveSheet()->setCellValue('BM4', "LIQUID CO2");
        ...
        $excel->getActiveSheet()->setCellValue('CE4', "VIS 8097SV");
       ...
       //0002-100010
        ...
        //TARGET QTY
        $excel->getActiveSheet()->setCellValue('CG2', "Target Qty");
        $excel->getActiveSheet()->getStyle('CG2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $excel->getActiveSheet()->mergeCells('CG2:DO2');
        $excel->getActiveSheet()->getStyle('CG2:DO2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D8DEAE');
        ...
        $excel->getActiveSheet()->setCellValue('CO3', "0000-100011");
        $excel->getActiveSheet()->setCellValue('CO4', "SEMEN A");
        $excel->getActiveSheet()->setCellValue('CP3', "0000-100017");
        $excel->getActiveSheet()->setCellValue('CP4', "SEMEN OPC TYPE 2");
        $excel->getActiveSheet()->setCellValue('CQ3', "0000-100060");
        $excel->getActiveSheet()->setCellValue('CQ4', "SEMEN VAS");
        $excel->getActiveSheet()->setCellValue('CR3', "0000-000015");
        $excel->getActiveSheet()->setCellValue('CR4', "Fly Ash");
        $excel->getActiveSheet()->setCellValue('CS3', "0000-100030");
        $excel->getActiveSheet()->setCellValue('CS3', "Air");
        $excel->getActiveSheet()->setCellValue('CT3', "0002-100442");
        $excel->getActiveSheet()->setCellValue('CT4', "FLOBAS RPF-34");
        $excel->getActiveSheet()->setCellValue('CU3', "0000-100040");
        $excel->getActiveSheet()->setCellValue('CU4', " STEEL AGG1");
        $excel->getActiveSheet()->setCellValue('CV3', "0002-100030");
        $excel->getActiveSheet()->setCellValue('CV4', "LIQUID CO2");
        $excel->getActiveSheet()->setCellValue('CW3', "0002-100020");
        $excel->getActiveSheet()->setCellValue('CW4', "SBT CON-M");
        $excel->getActiveSheet()->setCellValue('CX3', "0002-100202");
        $excel->getActiveSheet()->setCellValue('CX4', "SBT JM-9");
        $excel->getActiveSheet()->setCellValue('CY3', "0000-100021");
        $excel->getActiveSheet()->setCellValue('CY4', "SEMEN C");
        $excel->getActiveSheet()->setCellValue('CZ3', "0000-100063");
        $excel->getActiveSheet()->setCellValue('CZ4', "AGG1 VAS");
        $excel->getActiveSheet()->setCellValue('DA3', "0000-100064");
        $excel->getActiveSheet()->setCellValue('DA4', "AGG2 VAS");
        $excel->getActiveSheet()->setCellValue('DB3', "0000-100065");
        $excel->getActiveSheet()->setCellValue('DB4', "AGG3 VAS");
        $excel->getActiveSheet()->setCellValue('DC3', "0000-100061");
        $excel->getActiveSheet()->setCellValue('DC4', "SAND VAS");
        $excel->getActiveSheet()->setCellValue('DD3', "0002-100028");
        $excel->getActiveSheet()->setCellValue('DD4', "GCP P26");
        $excel->getActiveSheet()->setCellValue('DE3', "0002-100029");
        $excel->getActiveSheet()->setCellValue('DE4', "GCP 512LN");
        $excel->getActiveSheet()->setCellValue('DF3', "0002-100027");
        $excel->getActiveSheet()->setCellValue('DF4', "FLBPF-24");
        $excel->getActiveSheet()->setCellValue('DG3', "0002-100449");
        $excel->getActiveSheet()->setCellValue('DG4', "FLBPD-14");
        $excel->getActiveSheet()->setCellValue('DH3', "0002-100021");
        $excel->getActiveSheet()->setCellValue('DH4', "SBT PCA-8S");
        $excel->getActiveSheet()->setCellValue('DI3', "0002-100437");
        $excel->getActiveSheet()->setCellValue('DI4', "GENR8212");
        $excel->getActiveSheet()->setCellValue('DJ3', "0002-100438");
        $excel->getActiveSheet()->setCellValue('DJ4', "GET702");
        $excel->getActiveSheet()->setCellValue('DK3', "0002-100439");
        $excel->getActiveSheet()->setCellValue('DK4', "GENB1714");
        $excel->getActiveSheet()->setCellValue('DL3', "0000-100098");
        $excel->getActiveSheet()->setCellValue('DL4', "B SAND");
        $excel->getActiveSheet()->setCellValue('DM3', "0002-100440");
        $excel->getActiveSheet()->setCellValue('DM4', "FLBNF-15");
        $excel->getActiveSheet()->setCellValue('DN3', "0002-100467");
        $excel->getActiveSheet()->setCellValue('DN4', "VIS 8097SV");
        $excel->getActiveSheet()->setCellValue('DO3', "0002-100023");
        $excel->getActiveSheet()->setCellValue('DO4', "GENCB10");
       ...
       //0002-100010
        ...
        //MOISTURE 
         $excel->getActiveSheet()->setCellValue('DP2', "Moisture");
        $excel->getActiveSheet()->getStyle('DP2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $excel->getActiveSheet()->mergeCells('DP2:DW2');
        $excel->getActiveSheet()->getStyle('DP2:DW2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('C1DAD6');
        $excel->getActiveSheet()->setCellValue('DP3', "0000-100094");
        $excel->getActiveSheet()->setCellValue('DP4', "Pasir");
        $excel->getActiveSheet()->setCellValue('DQ3', "0000-100089");
        $excel->getActiveSheet()->setCellValue('DQ4', "MSand");
        $excel->getActiveSheet()->setCellValue('DR3', "0000-100093");
        $excel->getActiveSheet()->setCellValue('DR4', "STONEDUST");
        $excel->getActiveSheet()->setCellValue('DS3', "0000-100090");
        $excel->getActiveSheet()->setCellValue('DS4', "AGG1");
        $excel->getActiveSheet()->setCellValue('DT3', "0000-100091");
        $excel->getActiveSheet()->setCellValue('DT4', "AGG2");
        $excel->getActiveSheet()->setCellValue('DU3', "0000-100092");
        $excel->getActiveSheet()->setCellValue('DU4', "AGG3");
        $excel->getActiveSheet()->setCellValue('DV3', "0000-000029");
        $excel->getActiveSheet()->setCellValue('DV4', "SEMEN B");
        $excel->getActiveSheet()->setCellValue('DW3', "0000-100097");
        $excel->getActiveSheet()->setCellValue('DW4', "STEEL DUST");

        
        //VARIANCE
        $excel->getActiveSheet()->setCellValue('DX2', "Variance Percentage");
        $excel->getActiveSheet()->getStyle('DX2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $excel->getActiveSheet()->mergeCells('DX2:FB2');
         $excel->getActiveSheet()->getStyle('DX2:FB2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('7DB6D5');   
        $excel->getActiveSheet()->setCellValue('DX3', "0000-100094");
        $excel->getActiveSheet()->setCellValue('DX4', "Pasir");
        $excel->getActiveSheet()->setCellValue('DY3', "0000-100089");
        $excel->getActiveSheet()->setCellValue('DY4', "MSand");
        $excel->getActiveSheet()->setCellValue('DZ3', "0000-100093");
        $excel->getActiveSheet()->setCellValue('DZ4', "STONEDUST");
        $excel->getActiveSheet()->setCellValue('EA3', "0000-100090");
        $excel->getActiveSheet()->setCellValue('EA4', "AGG1");
        $excel->getActiveSheet()->setCellValue('EB3', "0000-100091");
        $excel->getActiveSheet()->setCellValue('EB4', "AGG2");
        $excel->getActiveSheet()->setCellValue('EC3', "0000-100092");
        $excel->getActiveSheet()->setCellValue('EC4', "AGG3");
        $excel->getActiveSheet()->setCellValue('ED3', "0000-000029");
        $excel->getActiveSheet()->setCellValue('ED4', "SEMEN B");
        $excel->getActiveSheet()->setCellValue('EE3', "0000-100097");
        $excel->getActiveSheet()->setCellValue('EE4', "STEEL DUST");
        $excel->getActiveSheet()->setCellValue('EF3', "0000-100011");
        $excel->getActiveSheet()->setCellValue('EF4', "SEMEN A");
        $excel->getActiveSheet()->setCellValue('EG3', "0000-100017");
        $excel->getActiveSheet()->setCellValue('EG4', "SEMEN OPC TYPE 2");
        $excel->getActiveSheet()->setCellValue('EH3', "0000-100060");
        $excel->getActiveSheet()->setCellValue('EH4', "SEMEN VAS");
        $excel->getActiveSheet()->setCellValue('EI3', "0000-000015");
        $excel->getActiveSheet()->setCellValue('EI4', "Fly Ash");
        $excel->getActiveSheet()->setCellValue('EJ3', "0000-100030");
        $excel->getActiveSheet()->setCellValue('EJ4', "Air");
        $excel->getActiveSheet()->setCellValue('EK3', "0002-100442");
        $excel->getActiveSheet()->setCellValue('EK4', "FLOBAS RPF-34");
        $excel->getActiveSheet()->setCellValue('EL3', "0000-100040");
        $excel->getActiveSheet()->setCellValue('EL4', " STEEL AGG1");
        $excel->getActiveSheet()->setCellValue('EM3', "0002-100030");
        $excel->getActiveSheet()->setCellValue('EM4', "LIQUID CO2");
        $excel->getActiveSheet()->setCellValue('EN3', "0002-100020");
        $excel->getActiveSheet()->setCellValue('EN4', "SBT CON-M");
        $excel->getActiveSheet()->setCellValue('EO3', "0002-100202");
        $excel->getActiveSheet()->setCellValue('EO4', "SBT JM-9");
        $excel->getActiveSheet()->setCellValue('EP3', "0000-100021");
        $excel->getActiveSheet()->setCellValue('EP4', "SEMEN C");
        $excel->getActiveSheet()->setCellValue('EQ3', "0000-100063");
        $excel->getActiveSheet()->setCellValue('EQ4', "AGG1 VAS");
        $excel->getActiveSheet()->setCellValue('ER3', "0000-100064");
        $excel->getActiveSheet()->setCellValue('ER4', "AGG2 VAS");
        $excel->getActiveSheet()->setCellValue('ES3', "0000-100065");
        $excel->getActiveSheet()->setCellValue('ES4', "AGG3 VAS");
        $excel->getActiveSheet()->setCellValue('ET3', "0000-100061");
        $excel->getActiveSheet()->setCellValue('ET4', "SAND VAS");
        $excel->getActiveSheet()->setCellValue('EU3', "0002-100028");
        $excel->getActiveSheet()->setCellValue('EU4', "GCP P26");
        $excel->getActiveSheet()->setCellValue('EV3', "0002-100029");
        $excel->getActiveSheet()->setCellValue('EV4', "GCP 512LN");
        $excel->getActiveSheet()->setCellValue('EW3', "0002-100027");
        $excel->getActiveSheet()->setCellValue('EW4', "FLBPF-24");
        $excel->getActiveSheet()->setCellValue('EX3', "0002-100449");
        $excel->getActiveSheet()->setCellValue('EX4', "FLBPD-14");
        $excel->getActiveSheet()->setCellValue('EY3', "0002-100021");
        $excel->getActiveSheet()->setCellValue('EY4', "SBT PCA-8S");
        $excel->getActiveSheet()->setCellValue('EZ3', "0002-100437");
        $excel->getActiveSheet()->setCellValue('EZ4', "GENR8212");
        $excel->getActiveSheet()->setCellValue('FA3', "0002-100438");
        $excel->getActiveSheet()->setCellValue('FA4', "GET702");
        $excel->getActiveSheet()->setCellValue('FB3', "0002-100439");
        $excel->getActiveSheet()->setCellValue('FB4', "GENB1714");
        $excel->getActiveSheet()->setCellValue('FC3', "0000-100098");
        $excel->getActiveSheet()->setCellValue('FC4', "B SAND");
        $excel->getActiveSheet()->setCellValue('FD3', "0002-100440");
        $excel->getActiveSheet()->setCellValue('FD4', "FLBNF-15");
        $excel->getActiveSheet()->setCellValue('FE3', "0002-100467");
        $excel->getActiveSheet()->setCellValue('FE4', "VIS 8097SV");
        $excel->getActiveSheet()->setCellValue('FF3', "0002-100023");
        $excel->getActiveSheet()->setCellValue('FF4', "GENCB10");
        //agg3vas
       //0002-100010
        
        
        //USAGE
        $excel->getActiveSheet()->setCellValue('FG2', "Usage Percentage");
        $excel->getActiveSheet()->getStyle('FG2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        $excel->getActiveSheet()->mergeCells('FG2:FI3');
        $excel->getActiveSheet()->getStyle('FG2:FI3')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('FFF8DC');
       
        $excel->getActiveSheet()->setCellValue('FG4', "Sand Percentage");
//        $excel->getActiveSheet()->mergeCells('BT4:BT4');
        $excel->getActiveSheet()->setCellValue('FH4', "MSand Percentage");
//        $excel->getActiveSheet()->mergeCells('BU4:BU4');
        $excel->getActiveSheet()->setCellValue('FI4', "FA Percentage");
//        $excel->getActiveSheet()->mergeCells('BV4:BV4');
        $excel->getActiveSheet()->setCellValue('FJ2', "Process Code");
        $excel->getActiveSheet()->mergeCells('FJ2:FJ4');
        $excel->getActiveSheet()->setCellValue('FK2', "Desc");
        $excel->getActiveSheet()->mergeCells('FK2:FK4');
        $excel->getActiveSheet()->setCellValue('FL2', "Remarks");
        $excel->getActiveSheet()->mergeCells('FL2:FL4');
        ...
        $excel->getActiveSheet()->getStyle('A5:FL5')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D17DEAE');
        ...
        while($obj = $result->fetch_object()){
            ...
            $excel->getActiveSheet()->setCellValue('L5', $received_vol_sum);
              ...
              $query_select_total = "SELECT `material_code`,`design_qty`,`actual_qty`,`target_qty` FROM `batch_transaction`,`tmp_exsport_akumulasi`
                                    WHERE `batch_transaction`.`docket_no` = `tmp_exsport_akumulasi`.`docket_no`
            ...
            if($result_total = $mysqli->query($query_select_total)){
                ...
                $act_total_STEELAGG1    = 0;
                $act_total_skhe     = 0;
                $act_total_semenc  = 0;
                $act_total_agg1vas = 0;
                $act_total_agg2vas = 0;
                $act_total_liquidco2     = 0;
                $act_total_sbtconm    = 0;
                $act_total_sbtjm9   = 0;
                $act_total_agg3vas   = 0;
                $act_total_BSAND = 0;
                ...
                $tar_total_STEELAGG1    = 0;
                $tar_total_skhe     = 0;
                $tar_total_semenc  = 0;
                $tar_total_agg1vas = 0;
                $tar_total_agg2vas = 0;
                $tar_total_liquidco2     = 0;
                $tar_total_sbtconm    = 0;
                $tar_total_sbtjm9    = 0;
                $tar_total_agg3vas   = 0;
                $tar_total_BSAND = 0;
                ...
                $tar_total_gencb10 = 0;
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    if($obj_total->material_code == "0000-100094"){ //sand / pasir
                        ...
                        $excel->getActiveSheet()->setCellValue('AX5', $act_total_sand);
                        $excel->getActiveSheet()->setCellValue('CG5', $tar_total_sand);
                    }
                    elseif($obj_total->material_code == "0000-100089"){ //MSand
                        $act_total_msand+=$obj_total->actual_qty;
                        $tar_total_msand+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('AY5', $act_total_msand);
                        $excel->getActiveSheet()->setCellValue('CH5', $tar_total_msand);
                    }
                     elseif($obj_total->material_code == "0000-100093"){ // STONEDUST 
                        ...
                        $excel->getActiveSheet()->setCellValue('AZ5', $act_total_stonedust);
                        $excel->getActiveSheet()->setCellValue('CI5', $tar_total_stonedust);
                    }
                    elseif($obj_total->material_code == "0000-100090"){ //AGG1 
                        $act_total_agg1+=$obj_total->actual_qty;
                        $tar_total_agg1+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BA5', $act_total_agg1);
                        $excel->getActiveSheet()->setCellValue('CJ5', $tar_total_agg1);
                    }
                    elseif($obj_total->material_code == "0000-100091"){ //AGG2
                        $act_total_agg2+=$obj_total->actual_qty;
                        $tar_total_agg2+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BB5', $act_total_agg2);
                        $excel->getActiveSheet()->setCellValue('CK5', $tar_total_agg2);
                    }
                    elseif($obj_total->material_code == "0000-100092"){ //AGG3
                        $act_total_agg3+=$obj_total->actual_qty;
                        $tar_total_agg3+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BC5', $act_total_agg3);
                        $excel->getActiveSheet()->setCellValue('CL5', $tar_total_agg3);
                    }
                     elseif($obj_total->material_code == "0000-000029"){ //semen B
                        $act_total_semen2+=$obj_total->actual_qty;
                        $tar_total_semen2+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BD5', $act_total_semen2);
                        $excel->getActiveSheet()->setCellValue('CM5', $tar_total_semen2);
                    } 
                     elseif($obj_total->material_code == "0000-100097"){ //STEEL DUST
                        $act_total_stldust+=$obj_total->actual_qty;
                        $tar_total_stldust+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BE5', $act_total_stldust);
                        $excel->getActiveSheet()->setCellValue('CN5', $tar_total_stldust);
                    } 
                    elseif($obj_total->material_code == "0000-100011"){ //semen A  
                        $act_total_semenA+=$obj_total->actual_qty;
                        $tar_total_semenA+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BF5', $act_total_semenA);
                        $excel->getActiveSheet()->setCellValue('CO5', $tar_total_semenA);
                    }
                    elseif($obj_total->material_code == "0000-100017"){ //Cementtp2  
                        ...
                        $excel->getActiveSheet()->setCellValue('BG5', $act_total_cementtp2);
                        $excel->getActiveSheet()->setCellValue('CP5', $tar_total_cementtp2);
                    }
                    elseif($obj_total->material_code == "0000-100060"){ //Cementvas  
                        ...
                        $excel->getActiveSheet()->setCellValue('BH5', $act_total_cementvas);
                        $excel->getActiveSheet()->setCellValue('CQ5', $tar_total_cementvas);
                    }
                    elseif($obj_total->material_code == "0000-000015"){ //Flying Ash
                        $act_total_fa+= $obj_total->actual_qty;
                        $tar_total_fa+= $obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BI5', $act_total_fa);
                        $excel->getActiveSheet()->setCellValue('CR5', $tar_total_fa);
                    }
                    elseif($obj_total->material_code == "0000-100030"){ // water / Air 
                        ...
                        $excel->getActiveSheet()->setCellValue('BJ5', $act_total_water);
                        $excel->getActiveSheet()->setCellValue('CS5', $tar_total_water);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100001"){ //P 121 R 
                        ...
                        $excel->getActiveSheet()->setCellValue('BK5', $act_total_flobasRpf34);
                        $excel->getActiveSheet()->setCellValue('CT5', $tar_total_flobasRpf34);
                    }
                    elseif($obj_total->material_code == "0000-100040"){ // STEEL AGG1
                        $act_total_STEELAGG1+=$obj_total->actual_qty;
                        $tar_total_STEELAGG1+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BL5', $act_total_STEELAGG1);
                        $excel->getActiveSheet()->setCellValue('CU5', $tar_total_STEELAGG1);
                    }
                    elseif($obj_total->material_code == "0002-100030"){ //liquidco2
                        $act_total_liquidco2+=$obj_total->actual_qty;
                        $tar_total_liquidco2+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BM5', $act_total_liquidco2);
                        $excel->getActiveSheet()->setCellValue('CV5', $tar_total_liquidco2);
                    }
                    elseif($obj_total->material_code == "0002-100020"){ //sbtconm
                        ...
                        $excel->getActiveSheet()->setCellValue('BN5', $act_total_sbtconm);
                        $excel->getActiveSheet()->setCellValue('CW5', $tar_total_sbtconm);
                    }
                    elseif($obj_total->material_code == "0002-100202"){ //sbtjm9
                        ...
                        $excel->getActiveSheet()->setCellValue('BO5', $act_total_sbtjm9);
                        $excel->getActiveSheet()->setCellValue('CX5', $tar_total_sbtjm9);
                    }
                    elseif($obj_total->material_code == "0000-100021"){ //SEMEN C 
                        $act_total_semenc+=$obj_total->actual_qty;
                        $tar_total_semenc+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BP5', $act_total_semenc);
                        $excel->getActiveSheet()->setCellValue('CY5', $tar_total_semenc);
                    }
                    elseif($obj_total->material_code == "0000-100063"){ //VIS 1212R
                        ...
                        $excel->getActiveSheet()->setCellValue('BQ5', $act_total_agg1vas);
                        $excel->getActiveSheet()->setCellValue('CZ5', $tar_total_agg1vas);
                    }
                    elseif($obj_total->material_code == "0000-100064"){ //VIS 7080p 
                        ...
                        $excel->getActiveSheet()->setCellValue('BR5', $act_total_agg2vas);
                        $excel->getActiveSheet()->setCellValue('DA5', $tar_total_agg2vas);
                    }
                    elseif($obj_total->material_code == "0000-100065"){ //SR 3200
                        ...
                        $excel->getActiveSheet()->setCellValue('BS5', $act_total_agg3vas);
                        $excel->getActiveSheet()->setCellValue('DB5', $tar_total_agg3vas);
                    }    
                    ...
                    elseif($obj_total->material_code == "0000-100061"){ //sandvas 
                        ...
                        $excel->getActiveSheet()->setCellValue('BT5', $act_total_sandvas);
                        $excel->getActiveSheet()->setCellValue('DC5', $tar_total_sandvas);
                    }                        
                    elseif($obj_total->material_code == "0002-100028"){ //GCP P26
                        $act_total_gcpp26+=$obj_total->actual_qty;
                        $tar_total_gcpp26+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BU5', $act_total_gcpp26);
                        $excel->getActiveSheet()->setCellValue('DD5', $tar_total_gcpp26);
                    }        
                    elseif($obj_total->material_code == "0002-100029"){ //GCP 512LN 
                        $act_total_gcp512ln+=$obj_total->actual_qty;
                        $tar_total_gcp512ln+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BV5', $act_total_gcp512ln);
                        $excel->getActiveSheet()->setCellValue('DE5', $tar_total_gcp512ln);
                    }              
                    elseif($obj_total->material_code == "0002-100027"){ //MAST 1100 
                        $act_total_flbpf24+=$obj_total->actual_qty;
                        $tar_total_flbpf24+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BW5', $act_total_flbpf24);
                        $excel->getActiveSheet()->setCellValue('DF5', $tar_total_flbpf24);
                    }    
                    elseif($obj_total->material_code == "0002-100449"){ //SIKAMENT
                        $act_total_FLBPD14+=$obj_total->actual_qty;
                        $tar_total_FLBPD14+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BX5', $act_total_FLBPD14);
                        $excel->getActiveSheet()->setCellValue('DG5', $tar_total_FLBPD14);
                    }          
                    elseif($obj_total->material_code == "0002-100021"){ //SBT PCA-8S
                        ...
                        $excel->getActiveSheet()->setCellValue('BY5', $act_total_sbtpca8s);
                        $excel->getActiveSheet()->setCellValue('DH5', $tar_total_sbtpca8s);
                    }    
                    elseif($obj_total->material_code == "0002-100437"){ //GENR 8212
                        ...
                        $excel->getActiveSheet()->setCellValue('BZ5', $act_total_genr8212);
                        $excel->getActiveSheet()->setCellValue('DI5', $tar_total_genr8212);
                    }       
                    elseif($obj_total->material_code == "0002-100438"){ //GET 702
                        ...
                        $excel->getActiveSheet()->setCellValue('CA5', $act_total_get702);
                        $excel->getActiveSheet()->setCellValue('DJ5', $tar_total_get702);
                    }           
                    elseif($obj_total->material_code == "0002-100439"){ //GENB 1714
                        ...
                        $excel->getActiveSheet()->setCellValue('CB5', $act_total_genb1714);
                        $excel->getActiveSheet()->setCellValue('DK5', $tar_total_genb1714);
                    }    
                     elseif($obj_total->material_code == "0000-100098"){ //B SAND 
                        $act_total_BSAND+=$obj_total->actual_qty;
                        $tar_total_BSAND+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('CC5', $act_total_BSAND);
                        $excel->getActiveSheet()->setCellValue('DL5', $tar_total_BSAND);
                    } 
                      elseif($obj_total->material_code == "0002-100440"){ //flbnf15
                        ...
                        $excel->getActiveSheet()->setCellValue('CD5', $act_total_flbnf15);
                        $excel->getActiveSheet()->setCellValue('DM5', $tar_total_flbnf15);
                    }    
                     elseif($obj_total->material_code == "0002-100467"){ //vis8097sv
                        $act_total_vis8097sv+=$obj_total->actual_qty;
                        $tar_total_vis8097sv+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('CE5', $act_total_vis8097sv);
                        $excel->getActiveSheet()->setCellValue('DN5', $tar_total_vis8097sv);
                    }
                    elseif($obj_total->material_code == "0002-100023"){ //gencb10
                        $act_total_gencb10+=$obj_total->actual_qty;
                        $tar_total_gencb10+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('CF5', $act_total_gencb10);
                        $excel->getActiveSheet()->setCellValue('DO5', $tar_total_gencb10);
                    }                            
                }
            ...
            $query_adj = "SELECT batch_transaction.`docket_no`,`batch_transaction`.`so_no`,`material_code`,`design_qty`,`actual_qty`,`target_qty` 
                          FROM `batch_transaction`,`tmp_exsport_akumulasi`
                          WHERE `batch_transaction`.`docket_no` = `tmp_exsport_akumulasi`.`docket_no`
                          AND `batch_transaction`.`delv_date` = '".$obj->delv_date."'";
            //echo $query_adj; exit();
            if($result_detail_adj = $mysqli->query($query_adj)){
                $docket = 0;
            }

             $query_select_detail = "SELECT * "
                    . "FROM `tmp_exsport_akumulasi` "
                    //. "WHERE `so_no` = '".$obj->so_no."' AND `docket_no` = '".$obj->docket_no."'";
                    . "WHERE `docket_no` = '".$obj->docket_no."'";
            if($result_detail = $mysqli->query($query_select_detail)){
                ...
                while($obj_detail = $result_detail->fetch_object()){     
                    ...
                    if($obj_detail->material_code == "0000-100094"){ //sand / pasir
                        ...
                        $excel->getActiveSheet()->setCellValue('DP'.$row, $obj_detail->moisture);
                    }
                    elseif($obj_detail->material_code == "0000-100089"){ //MSand
                        ...
                        $excel->getActiveSheet()->setCellValue('DQ'.$row, $obj_detail->moisture);
                    ...
                    elseif($obj_detail->material_code == "0000-100093"){ //StoneDust
                        ...
                        $excel->getActiveSheet()->setCellValue('DR'.$row, $obj_detail->moisture);
                    ...
                    elseif($obj_detail->material_code == "0000-100090"){ //AGG1 
                        ...
                        $excel->getActiveSheet()->setCellValue('DS'.$row, $obj_detail->moisture);
                    ...
                    elseif($obj_detail->material_code == "0000-100091"){ //AGG2
                        ...
                        $excel->getActiveSheet()->setCellValue('DT'.$row, $obj_detail->moisture);
                    ...
                    elseif($obj_detail->material_code == "0000-100092"){ //AGG3
                        ...
                        $excel->getActiveSheet()->setCellValue('DU'.$row, $obj_detail->moisture);
                      
                    }
                     elseif($obj_detail->material_code == "0000-000029"){ //SEMEN B
                        $moi_qty_semen2+=$obj_detail->moisture;
                        ...
                        $act_qty_semen2+=$obj_detail->actual_qty;
                        $tar_qty_semen2+=$obj_detail->target_qty;
                    }  
                    ...
                    elseif($obj_detail->material_code == "0000-100011"){ //semenA 
                        ...
                        $act_qty_semenA+=$obj_detail->actual_qty;
                        $tar_qty_semenA+=$obj_detail->target_qty;
                    }
                    ...
                    elseif($obj_detail->material_code == "0000-100040"){ //STEEL AGG1 
                        $excel->getActiveSheet()->setCellValue("BL".$row, $obj_detail->actual_qty);
                    ...
                    elseif($obj_detail->material_code == "0002-100030"){ //liquidco2
                        ...
                        $act_qty_liquidco2+=$obj_detail->actual_qty;
                        $tar_qty_liquidco2+=$obj_detail->target_qty;
                    }
                    ...
                    elseif($obj_detail->material_code == "0000-100063"){ //AGG1 VAS
                    ...
                    elseif($obj_detail->material_code == "0000-100064"){ //AGG2 VAS
                    ...
                    elseif($obj_detail->material_code == "0000-100065"){ //AGG3 VAS
                    ...
                    elseif($obj_detail->material_code == "0002-100028"){ //GCP P26
                    ...
                    elseif($obj_detail->material_code == "0002-100029"){ //GCP 512LN
                    ...
                    elseif($obj_detail->material_code == "0002-100027"){ //SIKAMENT
                    ...
                    elseif($obj_detail->material_code == "0000-100098"){ //B SAND
                    ...
                    elseif($obj_detail->material_code == "0002-100440"){ //flbnf15
                        ...
                        $excel->getActiveSheet()->setCellValue("DM".$row, $obj_detail->target_qty);
                    ...
                    elseif($obj_detail->material_code == "0002-100467"){ //vis8097sv
                        $excel->getActiveSheet()->setCellValue("CE".$row, $obj_detail->actual_qty);
                        $excel->getActiveSheet()->setCellValue("DN".$row, $obj_detail->target_qty);
                        $act_qty_vis8097sv+=$obj_detail->actual_qty;
                        $tar_qty_vis8097sv+=$obj_detail->target_qty;
                    } 
                    elseif($obj_detail->material_code == "0002-100023"){ //gencb10
                        $excel->getActiveSheet()->setCellValue("CF".$row, $obj_detail->actual_qty);
                        $excel->getActiveSheet()->setCellValue("DO".$row, $obj_detail->target_qty);
                        $act_qty_vis8097sv+=$obj_detail->actual_qty;
                        $tar_qty_vis8097sv+=$obj_detail->target_qty;
                    }                                           
            ...
            while($obj1 = $result_detail1->fetch_object()){     
                    ...
                    elseif($obj1->material_code == "0000-100092"){ //AGG3
                     ...
                     elseif($obj1->material_code == "0000-000029"){ //SEMENB
                        $nor_qty_semen2+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("U".$row, $obj1->mix_qty);
                        
                       
                    }  
                     elseif($obj1->material_code == "0000-100097"){ //STEEL DUST
                    ...
                    elseif($obj1->material_code == "0000-100011"){ //semenA 
                        $nor_qty_semenA+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0002-100442"){ //Flobas Rpf34
                        $nor_qty_flobasRpf34+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AB".$row, $obj1->mix_qty);
                        
                    }
                    elseif($obj1->material_code == "0000-100040"){ //STEEL AGG1
                        $nor_qty_STEELAGG1+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AC".$row, $obj1->mix_qty); 
                    
                    }
                    elseif($obj1->material_code == "0002-100030"){ //liquidco2
                        $nor_qty_liquidco2+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0002-100028"){ //GCP P26
                        $nor_qty_gcpp26+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AL".$row, $obj1->mix_qty);

                    }        
                    elseif($obj1->material_code == "0002-100029"){ //GCP 512LN
                        $nor_qty_gcp512ln+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AM".$row, $obj1->mix_qty);

                    }     
                    elseif($obj1->material_code == "0002-100027"){ //MAST 1100
                        $nor_qty_flbpf24+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0002-100021"){ //SBT PCA-8S
                    ...
                    elseif($obj1->material_code == "0000-100098"){ //B SAND
                        $nor_qty_BSAND+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0002-100467"){ //vis8097sv
                        $nor_qty_vis8097sv+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AV".$row, $obj1->mix_qty);
   
                    }
                    elseif($obj1->material_code == "0002-100023"){ //gencb10
                        $nor_qty_gencb10+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AW".$row, $obj1->mix_qty);
               ...
               if($act_qty_fa+$act_qty_semenA==0){$fa_percentage=0;}
                else{$fa_percentage = 100*($act_qty_fa/($act_qty_fa+$act_qty_semenA));}
                ...
                if($tar_qty_sand === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("DX".$row, round($var_sand,2));
                }
                //msand
                if($tar_qty_msand === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("DY".$row, round($var_msand,2));
                }
                //stonedust
                if($tar_qty_stonedust === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("DZ".$row,"");
                        ...
                        $excel->getActiveSheet()->setCellValue("DZ".$row, round($var_stonedust,2));
                }
                //agg1
                if($tar_qty_agg1 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EA".$row, round($var_agg1,2));
                }
                //agg2
                if($tar_qty_agg2 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EB".$row, round($var_agg2,2));
                }
                //agg3
                if($tar_qty_agg3 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EC".$row, round($var_agg3,2));
                }
                //var_AGG5
                 if($tar_qty_semen2 === 0){ 
                    ...
                    $var_semen2 = (($act_qty_semen2 - $tar_qty_semen2)/($tar_qty_semen2))*100;
                    $excel->getActiveSheet()->setCellValue("ED".$row, round($var_semen2,2));
                }
                //var_steeldust
                 if($tar_qty_stldust === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EE".$row, round($var_stldust,2));
                }
                
                //sementtp1
                if($tar_qty_semenA === 0){//$var_cement = 0;
                    $excel->getActiveSheet()->setCellValue("EF".$row,"");
                }
                else{$var_semenA = (($act_qty_semenA - $tar_qty_semenA)/($tar_qty_semenA))*100;}
                $excel->getActiveSheet()->setCellValue("EF".$row, round($var_semenA,2));
                //sementtp2        
                ...
                $excel->getActiveSheet()->setCellValue("EG".$row, round($var_cementtp2,2));
                //semenpcc
                ...
                $excel->getActiveSheet()->setCellValue("EH".$row, round($var_cementvas,2));
                ...
                if($tar_qty_fa === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EI".$row, round($var_fa,2));
                }
                if($tar_qty_water === 0){
                    //$var_water = 0;
                    $excel->getActiveSheet()->setCellValue("EJ".$row,"");
                        ...
                        $excel->getActiveSheet()->setCellValue("EJ".$row, round($var_water,2));
                }
                ...
                if($tar_qty_flobasRpf34 === 0){
                  //  $var_flobasRpf34 = 0;
                    ...
                    $excel->getActiveSheet()->setCellValue("EK".$row, round($var_flobasRpf34,2));
                }
                if($tar_qty_STEELAGG1 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EL".$row, round($var_STEELAGG1,2));
                }
                if ($tar_qty_liquidco2 === 0){
                    $excel->getActiveSheet()->setCellValue("EM".$row,"");
                }else{
                    $var_liquidco2 = (($act_qty_liquidco2 - $tar_qty_liquidco2)/($tar_qty_liquidco2))*100;
                    $excel->getActiveSheet()->setCellValue("EM".$row, round($var_liquidco2,2));
                }
                //sbtconm
                if($tar_qty_sbtconm === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EN".$row, round($var_sbtconm,2));
                }
                //sbtjm9
                if($tar_qty_sbtjm9 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EO".$row, round($var_sbtjm9,2));
                }
                //SEMEN C
                if($tar_qty_semenc === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EP".$row, round($var_semenc,2));
                }
                ...
                if($tar_qty_agg1vas === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EQ".$row, round($var_agg1vas,2));
                }
                ...
                if($tar_qty_agg2vas === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("ER".$row, round($var_agg2vas,2));
                }
                //var_agg3vas
                if($tar_qty_agg3vas === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("ES".$row, round($var_agg3vas,2));
                }
                 //var_B SAND
                 ...
                 if($tar_qty_sandvas === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("ET".$row, round($var_sandvas,2));
                }
                 //var_gcpp26
                 if($tar_qty_gcpp26 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EU".$row, round($var_gcpp26,2));
                }
                //var_GCP 512LN
                if($tar_qty_gcp512ln === 0){ 
                    $excel->getActiveSheet()->setCellValue("EV".$row,"");
                }
                else{
                    $var_gcp512ln = (($act_qty_gcp512ln - $tar_qty_gcp512ln)/($tar_qty_gcp512ln))*100;
                    $excel->getActiveSheet()->setCellValue("EV".$row, round($var_gcp512ln,2));
                }
                //var_flbpf24
                if($tar_qty_flbpf24 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EW".$row, round($var_flbpf24,2));
                }
                //var_FLBPD14
                if($tar_qty_FLBPD14 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EX".$row, round($var_FLBPD14,2));
                }
                //var_sbtpca8s
                if($tar_qty_sbtpca8s === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EY".$row, round($var_sbtpca8s,2));
                }
                //var_genr8212
                if($tar_qty_genr8212 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EZ".$row, round($var_genr8212,2));
                }
                //var_get702
                if($tar_qty_get702 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("FA".$row, round($var_get702,2));
                }
                 //var_genb1714
                 if($tar_qty_genb1714 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("FB".$row, round($var_genb1714,2));
                }
                 if($tar_qty_BSAND === 0){ 
                    $excel->getActiveSheet()->setCellValue("FC".$row,"");
                }
                else{
                    $var_BSAND = (($act_qty_BSAND - $tar_qty_BSAND)/($tar_qty_BSAND))*100;
                    $excel->getActiveSheet()->setCellValue("FC".$row, round($var_BSAND,2));
                }
                 if($tar_qty_flbnf15 === 0){ 
                    $excel->getActiveSheet()->setCellValue("FD".$row,"");
                }
                else{
                    $var_flbnf15 = (($act_qty_flbnf15 - $tar_qty_flbnf15)/($tar_qty_flbnf15))*100;
                    $excel->getActiveSheet()->setCellValue("FD".$row, round($var_flbnf15,2));
                }
                 if($tar_qty_vis8097sv === 0){ 
                    $excel->getActiveSheet()->setCellValue("FE".$row,"");
                }
                else{
                    $var_vis8097sv = (($act_qty_vis8097sv - $tar_qty_vis8097sv)/($tar_qty_vis8097sv))*100;
                    $excel->getActiveSheet()->setCellValue("FE".$row, round($var_vis8097sv,2));
                }
                if($tar_qty_gencb10 === 0){ 
                    $excel->getActiveSheet()->setCellValue("FF".$row,"");
                }
                else{
                    $var_vis8097sv = (($act_qty_gencb10 - $tar_qty_gencb10)/($tar_qty_gencb10))*100;
                    $excel->getActiveSheet()->setCellValue("FF".$row, round($var_gencb10,2));
                }
                   
                
            }
           $excel->getActiveSheet()->setCellValue("FJ".$row, " ".$obj->process_code);
            $excel->getActiveSheet()->setCellValue("FK".$row, " ".$obj->desc);
            $excel->getActiveSheet()->setCellValue("FL".$row, " ".$obj->remarks);
            $row++;
            $index_excelColumn=0;
        }
