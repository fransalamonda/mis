...
//    while($row_name = $nama->fetch_array(MYSQLI_ASSOC)){
            ...
            elseif($row_mat['material_code'] == "0000-100040") $material_name = "STEEL AGG1"; //
            elseif($row_mat['material_code'] == "0000-100066") $material_name = "V SAND"; //
            ...
            elseif($row_mat['material_code'] == "0000-100098") $material_name = "B SAND"; //
            ...
            elseif($row_mat['material_code'] == "0002-100019") $material_name = "GENCB10";
