...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->setCellValue('AM3', "0000-100066");
        $excel->getActiveSheet()->setCellValue('AM4', "V SAND");
        ...
        $excel->getActiveSheet()->setCellValue('AW3', "0002-100023"); //GENCB 10
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->getStyle('AX2:CF2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('ff9800');
        ...
        $excel->getActiveSheet()->setCellValue('BU3', "0000-100062");
        $excel->getActiveSheet()->setCellValue('BU4', "STONE DUST VAS");
        $excel->getActiveSheet()->setCellValue('BV3', "0000-100066");
        $excel->getActiveSheet()->setCellValue('BV4', "V SAND");
        $excel->getActiveSheet()->setCellValue('BW3', "0002-100017");
        $excel->getActiveSheet()->setCellValue('BW4', "SIKAMENT183");
        ...
        $excel->getActiveSheet()->setCellValue('CE3', "0002-100441");
        $excel->getActiveSheet()->setCellValue('CE4', "FLBPD-19");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->getStyle('CG2:DO2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('c1ff4d');
        ...
        $excel->getActiveSheet()->setCellValue('CS4', "Air");
        ...
        $excel->getActiveSheet()->setCellValue('CV3', "0002-100006");
        $excel->getActiveSheet()->setCellValue('CV4', "RT6P");
        ...
        $excel->getActiveSheet()->setCellValue('DD3', "0000-100062");
        $excel->getActiveSheet()->setCellValue('DD4', "STONE DUST VAS");
        $excel->getActiveSheet()->setCellValue('DE3', "0000-100066");
        $excel->getActiveSheet()->setCellValue('DE4', "V SAND");
        $excel->getActiveSheet()->setCellValue('DF3', "0002-100017");
        $excel->getActiveSheet()->setCellValue('DF4', "SIKAMENT183");
        ...
        $excel->getActiveSheet()->setCellValue('DN3', "0002-100441");
        $excel->getActiveSheet()->setCellValue('DN4', "FLBPD-19");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('EM3', "0002-100006");
        $excel->getActiveSheet()->setCellValue('EM4', "RT6P");
        ...
        $excel->getActiveSheet()->setCellValue('EU3', "0000-100062");
        $excel->getActiveSheet()->setCellValue('EU4', "STONE DUST VAS");
        $excel->getActiveSheet()->setCellValue('EV3', "0000-100066");
        $excel->getActiveSheet()->setCellValue('EV4', "V SAND");
        $excel->getActiveSheet()->setCellValue('EW3', "0002-100017");
        $excel->getActiveSheet()->setCellValue('EW4', "SIKAMENT183");
        ...
        $excel->getActiveSheet()->setCellValue('FE3', "0002-100441");
        $excel->getActiveSheet()->setCellValue('FE4', "FLBPD-19");
...
//        $excel->getActiveSheet()->mergeCells('BV4:BV4');
        ...
        $excel->getActiveSheet()->getStyle('A5:FL5')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('80ff66');
        ...
        while($obj = $result->fetch_object()){
                ...
                $tar_total_gencb10 = 0;
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    ...
                    elseif($obj_total->material_code == "0002-100006"){ //RT6P
                        ...
                        $excel->getActiveSheet()->setCellValue('BM5', $act_total_rt6p);
                        $excel->getActiveSheet()->setCellValue('CV5', $tar_total_rt6p);
                    }
                    ...
                    elseif($obj_total->material_code == "0000-100062"){ //stone dust vas
                        $act_total_stonedustvas+=$obj_total->actual_qty;
                        $tar_total_stonedustvas+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BU5', $act_total_stonedustvas);
                        $excel->getActiveSheet()->setCellValue('DD5', $tar_total_stonedustvas);
                    }        
                    elseif($obj_total->material_code == "0000-100066"){ //V SAND 
                        $act_total_VSAND+=$obj_total->actual_qty;
                        $tar_total_VSAND+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BV5', $act_total_VSAND);
                        $excel->getActiveSheet()->setCellValue('DE5', $tar_total_VSAND);
                    }              
                    elseif($obj_total->material_code == "0002-100017"){ //MAST 1100 
                        ...
                        $excel->getActiveSheet()->setCellValue('BW5', $act_total_SIKAMENT183);
                        $excel->getActiveSheet()->setCellValue('DF5', $tar_total_SIKAMENT183);
                    }    
                    ...
                    elseif($obj_total->material_code == "0002-100439"){ //GENB 1714
                     ...
                     elseif($obj_total->material_code == "0002-100441"){ //flbpd19
                        ...
                        $excel->getActiveSheet()->setCellValue('CE5', $act_total_flbpd19);
                        $excel->getActiveSheet()->setCellValue('DN5', $tar_total_flbpd19);
                    }
            ...
            if($result_detail = $mysqli->query($query_select_detail)){
                ...
                while($obj_detail = $result_detail->fetch_object()){     
                    ...
                    elseif($obj_detail->material_code == "0000-100062"){ //stone dust vas
                    ...
                    elseif($obj_detail->material_code == "0000-100066"){ //V SAND
                        ...
                        $act_qty_VSAND+=$obj_detail->actual_qty;
                        $tar_qty_VSAND+=$obj_detail->target_qty;
                    }     
                    elseif($obj_detail->material_code == "0002-100017"){ //SIKAMENT
            ...
            while($obj1 = $result_detail1->fetch_object()){     
                    ...
                    elseif($obj1->material_code == "0002-100006"){ //RT6P
                        $nor_qty_rt6p+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0000-100062"){ //stone dust vas
                        $nor_qty_stonedustvas+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AL".$row, $obj1->mix_qty);

                    }        
                    elseif($obj1->material_code == "0000-100066"){ //V SAND
                        $nor_qty_VSAND+=$obj1->mix_qty;
               ...
               if($act_qty_fa+$act_qty_semenA==0){$fa_percentage=0;}
                ...
                if ($tar_qty_rt6p === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EM".$row, round($var_rt6p,2));
                }
                //sbtconm
                ...
                if($tar_qty_agg3vas === 0){ 
                 ...
                 if($tar_qty_stonedustvas === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EU".$row, round($var_stonedustvas,2));
                }
                //var_V SAND
                if($tar_qty_VSAND === 0){ 
                    ...
                    $var_VSAND = (($act_qty_VSAND - $tar_qty_VSAND)/($tar_qty_VSAND))*100;
                    $excel->getActiveSheet()->setCellValue("EV".$row, round($var_VSAND,2));
                }
                //var_SIKAMENT183
                if($tar_qty_SIKAMENT183 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EW".$row, round($var_SIKAMENT183,2));
                }
                //var_FLBPD14
                ...
                if($tar_qty_get702 === 0){ 
                 ...
                 if($tar_qty_flbpd19 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("FE".$row, round($var_flbpd19,2));
                }
                if($tar_qty_gencb10 === 0){ 
                    $excel->getActiveSheet()->setCellValue("FF".$row,"");
                }
                else{
                    $var_flbpd19 = (($act_qty_gencb10 - $tar_qty_gencb10)/($tar_qty_gencb10))*100;
