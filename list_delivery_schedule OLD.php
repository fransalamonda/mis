                                    ...
                                    <form method="post" action="" onSubmit="return validate();">
                                            <div class="portlet box blue">
                                                <table class="table table-bordered table-hover small">
                                                    <thead>
                                                        <tr>
                                                            <th>No</th><th>SO No</th><th>Prod Code</th><th>Delv Vol</th><th>Today Vol</th><th>Out Vol</th><th>Total Vol Load</th><th>Customer Name</th><th>Proj Location</th><th>Sales</th><th>Upload Date</th><th>Upload By</th>
                                                                <?php
                                                                    if(isset($object) && ($object->group_id==5 || $object->group_id==4)){
                                                                 ?>
                                        ...
                                        <?php
                                                ...
                                                if($row['ds_code'] == 'M'){ ?>
                                                        ...
                                                        <td><span class="label label-sm label-danger"><?php echo $row['sales_name'];?></span></td>
                                                        <td><span class="label label-sm label-danger"><?php echo $row['date_upload'];?></span></td>
                                                        <td><span class="label label-sm label-danger"><?php echo $row['username'];?></span></td>
                                                <?php if(isset($object) && ($object->group_id==5 || $object->group_id==4)){ ?>
                                                        <td><a href="#" class="delete_ds" data-id="<?php echo $row['so_no']; echo $row['schedule_date'];?>"  >Delete</a></td>
                                                <?php }else {     ?>
                                                        <td></td>
                                                <?php } ?>
                                            </tr>
                                           ...
                                           <?php } ?>
                                                ...
                                                <td><a href="#" class="delete_ds" data-id="<?php echo $row['so_no']; echo $row['schedule_date'];?>"  >Delete</a> <br><a href="batch_request.php?so_no=<?=$row['so_no'];?>">Send</a></td>
                                                <?php }else if(isset($object) && ($object->group_id==6)){ ?>
                                                <td><a href="batch_request.php?so_no=<?=$row['so_no'];?>">Send</a></td> 
