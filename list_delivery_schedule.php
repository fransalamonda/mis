                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-2 pull-left">
                                ...
                                <p style="Font-Size:30px;" colspan="3" class><b>PERHATIAN TOLONG DIBCA !!!</b></p>
                                <p style="color:red;" colspan="3" class><b>Jika Ragu dengan Sisa Vol ERP maka hubungi bagian sechedule atau bagian terkait Volume</b></p>
							<h1>
                                                            ...
                                                            if ($row['ds_code'] == 'M') { ?>
                                                                <tr class="danger">
                                                                    ...
                                                                    <?php if (isset($object) && ($object->group_id == 5 || $object->group_id == 4 || $object->group_id == 6 || $object->group_id == 2 || $object->group_id == 1)) { ?>
                                                                        <td><a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                            <br>
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a>
                                                                        </td>
                                                                    <?php } else {     ?>
                                                                        <td></td>
                                                                    <?php } ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php if ($row['out_volume'] == 0) { ?>
                                                                    ...
                                                                    <?php if (isset($object) && ($object->group_id == 4)) { ?>
                                                                        <td>
                                                                            <a href="carischedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-primary">Approved</a><br>
                                                                            <a href="#" class="delete_ds" data-id="<?php echo $row['so_no'];
                                                                            echo $row['schedule_date']; ?>" ><button  class=" btn btn-xs btn-danger">Delete</button></a><br>
                                                                            <a class=" btn btn-xs btn-success" href="batch_request.php?so_no=<?= $row['so_no']; ?>">
                                                                            Send</a><br>
                                                                            <a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                            
                                                                        </td>
                                                                         <?php } else if (isset($object) && ($object->group_id == 6|| $object->group_id == 5) &&  ($row['total_load'] == $row['qty_so'])) { ?>
                                                                        <td><a class=" btn btn-xs btn-info" href="#">Schedule Close</a><br> <a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                            <br>
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a>
                                                                        </td>
                                                                        <?php } else if (isset($object) && ($object->group_id == 6|| $object->group_id == 5) &&  ($row['total_load'] >= $row['qty_so'])) { ?>
                                                                        <td><a style="color:red;" href="#">Loading Over</a><br> <a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a></td>
                                                                    
                                                                         
                                                                    <?php } else if (isset($object) && ($object->group_id == 2)) { ?>
                                                                        <td><a class=" btn btn-xs btn-primary" href="carischedule.php?id=<?= $row['id']; ?>" >Approved</a><br> <a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a></td>
                                                                    
                                                                    <?php } else if (isset($object) && ($object->group_id == 0) && ($row[$jam] == 0)) { ?>
                                                                        <td>
                                                                         
                                                                         <a href="#" class=" btn btn-xs btn-danger">Hubungi SPV</a><br><a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                        <br>
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a></td>
                                                                        <?php } else if (isset($object) && ($object->group_id == 0) && ($row[$jam] == $volume_perbandingan) && ($row['so_no'] == $so_data)) { ?>
                                                                                <td> <a href="#" class="" style="color:#000000;" >Schedule Jam Berikutnya</a> <br>
                                                                                <a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                                <br>
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a></td>
                                                                    <?php } else if (isset($object) && ($object->group_id == 6)) { ?>
                                                                        <td><a class=" btn btn-xs btn-success" href="batch_request.php?so_no=<?= $row['so_no']; ?>">Send</a><br><a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                        <br>
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a></td>
                                                                    <?php } else if (isset($object) && ($object->group_id == 1)) { ?>
                                                                        <td><a href="viewschedule.php?id=<?= $row['id']; ?>" Pfstyle="color:#48D1CC;" class=" btn btn-xs btn-info">View</a></td>
                                                                    ...
                                                                    <?php } else {
                                                                        ...
                                                                        echo $row['schedule_date']; ?>"><button  class=" btn btn-xs btn-danger">Delete</button></a><br><a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View </a></td> 
                                                            ...
                                                            elseif ($dates > $dateu && $row['ds_code'] != 'M') {
                                                                ...
                                                                ?>
                                                                    <?php if ($row['out_volume'] == 0) { ?>
                                                                        ...
                                                                        <td><?php echo $row[$jamplus4]; ?></td>
                                                                             <?php if (isset($object) && ($object->group_id == 4)) { ?>
                                                                          <td>  <a href="carischedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-primary">Approved</a><br><a href="#" class="delete_ds" data-id="<?php echo $row['so_no'];
                                                                          
                                                                          echo $row['schedule_date']; ?>"><button  class=" btn btn-xs btn-danger">Delete</button></a> <br><a class=" btn btn-xs btn-success" href="batch_request.php?so_no=<?= $row['so_no']; ?>">Send</a><br><a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a></td>
                                                                                   <?php } else if (isset($object) && ($object->group_id == 6|| $object->group_id == 5) &&  ($row['total_load'] == $row['qty_so'])) { ?>
                                                                        <td><a class=" btn btn-xs btn-danger" href="#">Schedule Close</a><br> <a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                        <br>
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a></td>
                                                                                <?php } else if (isset($object) && ($object->group_id == 6|| $object->group_id == 5) &&  ($row['total_load'] >= $row['qty_so'])) { ?>
                                                                        <td><a style="color:red;" href="#">Loading Over</a><br> <a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a>
                                                                            <br>
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a></td>
                                                                        ...
                                                                        <?php } else if (isset($object) && ($object->group_id == 0) && ($row[$jam] == 0)) { ?>
                                                                         ...
                                                                         <?php } else if (isset($object) && ($object->group_id == 6)) { ?>
                                                                            ...
                                                                            <a href="schedulePending.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-warning">Pending</a></td>
                                                                        <?php } else if (isset($object) && ($object->group_id == 1)) { ?>
                                                                            <td><a href="viewschedule.php?id=<?= $row['id']; ?>" class=" btn btn-xs btn-info">View</a></td>
                                                                        <?php } else if (isset($object) && ($object->group_id == 7)) { ?>
