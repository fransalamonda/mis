...
<div class="col-md-12" >
                    ...
                    <div class="component">
                     ...
                     <div class="component">
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                              <p align="center">1</p>
                                <input type="" name="satu" class="form-control" readonly value="<?=$row['1'];?>" >
                            </div>

                             <div class="col-md-1">
                                 <p align="center">2</p>
                                <input type="" name="dua" class="form-control" readonly  value="<?=$row['2'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">3</p>
                                <input type="" name="tiga" class="form-control" readonly value="<?=$row['3'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">4</p>
                                <input type="" name="empat" class="form-control" readonly value="<?=$row['4'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">5</p>
                                <input type="" name="lima" class="form-control" readonly  value="<?=$row['5'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">6</p>
                                <input type="" name="enam" class="form-control" readonly  value="<?=$row['6'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">7</p>
                                <input type="" name="tujuh" class="form-control" readonly  value="<?=$row['7'];?>" >
                            </div>
                             <div class="col-md-1">
                                 <p align="center">8</p>
                                <input type="" name="delapan" class="form-control" readonly  value="<?=$row['8'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">9</p>
                                <input type="" name="sembilan" class="form-control" readonly  value="<?=$row['9'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">10</p>
                                <input type="" name="sepuluh" class="form-control" readonly  value="<?=$row['10'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">11</p>
                                <input type="" name="sebelas" class="form-control" readonly  value="<?=$row['11'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">12</p>
                                <input type="" name="duabelas" class="form-control" readonly  value="<?=$row['12'];?>">
                            </div>
                        </div>
                    </div>
                </div>
                     ...
                     <div class="component">
                        <div class="form-group">
                             ...
                             <div class="col-md-1">
                                 <p align="center">13</p>
                                <input type="" name="tigabelas" class="form-control" readonly  value="<?=$row['13'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">14</p>
                                <input type="" name="empatbelas" class="form-control" readonly  value="<?=$row['14'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">15</p>
                                <input type="" name="limabelas" class="form-control" readonly  value="<?=$row['15'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">16</p>
                                <input type="" name="enambelas" class="form-control" readonly  value="<?=$row['16'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">17</p>
                                <input type="" name="tujuhbelas" class="form-control" readonly  value="<?=$row['17'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">18</p>
                                <input type="" name="delapanbelas" class="form-control" readonly  value="<?=$row['18'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">19</p>
                                <input type="" name="sembilanbelas" class="form-control" readonly  value="<?=$row['19'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">20</p>
                                <input type="" name="duapuluh" class="form-control" readonly  value="<?=$row['20'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">21</p>
                                <input type="" name="duasatu" class="form-control" readonly  value="<?=$row['21'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">22</p>
                                <input type="" name="duadua" class="form-control" readonly value="<?=$row['22'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">23</p>
                                <input type="" name="duatiga" class="form-control" readonly  value="<?=$row['23'];?>">
                            </div>
                             <div class="col-md-1">
                                 <p align="center">24</p>
                                <input type="" name="duaempat" class="form-control" readonly  value="<?=$row['24'];?>">
                            </div>
                        </div>
                ...
                <div class="component">
                        <div class="form-group">
                            <label class="col-md-12 control-label" for="textinput">   <br>Keterangan Schedule Mundur:</label>  
                            <div class="col-md-12">
                               <textarea name="remark" minlength="5"  class="form-control" readonly required><?=$row['remark'];?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
