...
<html>
	<head>
            <title>Batch Transaction Export Full Report Akumulasi</title>
                ...
                <div class="row">
                    <div class="col-sm-12 colsm-offset-3">
                        <h1 class="page-header">
                            Export Full Batch Transaction Akumulasi
                            <?php
                    ...
                    if(isset($_GET['filter']) && !empty($_GET['filter'])){
                        if(isset($_GET['time']) && !empty($_GET['time'])){
                            extract($_GET);
                            $q = "SELECT * FROM `batch_transaction` WHERE `product_code` = 'Adjustment' AND `delv_date` = '$filter' AND `delv_time` BETWEEN '$time' AND '23:59'
                            ...
                            $q = "SELECT A.* FROM `batch_transaction` A "
                                    ...
                                    . "WHERE `product_code` = 'Adjustment' AND `delv_date` = '".$filter."' AND `mch_code`='".PLANT_ID."' "
                                    . "ORDER BY `docket_no` ASC";
                        }
                                ...
                                <form role="form" method="GET">
                                    <div class="form-group" style="padding-bottom: 0px;margin-bottom: 0px;">
                                        <div class="input-group date form_date col-md-12" data-date="" data-date-format="yyyymmdd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                            <input class="form-control" name="filter" size="16" type="text" value="" placeholder="Pilih Tanggal" readonly="" />
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form method="post" action="act/batch_transaction_export_act_akumulasi.php" >
                                            <div class="table-responsive">
