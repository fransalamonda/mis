...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->setCellValue('Y3', "0000-100018");
        $excel->getActiveSheet()->setCellValue('Y4', "SEMEN PCC");
        ...
        $excel->getActiveSheet()->setCellValue('AB4', "P121R");
        ...
        $excel->getActiveSheet()->setCellValue('AE3', "0002-100409");
        $excel->getActiveSheet()->setCellValue('AE4', "SK163");
        $excel->getActiveSheet()->setCellValue('AF3', "0002-100410");
        $excel->getActiveSheet()->setCellValue('AF4', "SIKATARD930");
        $excel->getActiveSheet()->setCellValue('AG3', "0002-100402");
        $excel->getActiveSheet()->setCellValue('AG4', "VIS 1003");
        $excel->getActiveSheet()->setCellValue('AH3', "0002-100407");
        $excel->getActiveSheet()->setCellValue('AH4', "VIS 1221R");
        $excel->getActiveSheet()->setCellValue('AI3', "0002-100416");
        $excel->getActiveSheet()->setCellValue('AI4', "VIS 7080P");
        $excel->getActiveSheet()->setCellValue('AJ3', "0002-100010");
        $excel->getActiveSheet()->setCellValue('AJ4', "SR3200");
        $excel->getActiveSheet()->setCellValue('AK3', "0002-100403");
        $excel->getActiveSheet()->setCellValue('AK4', "V3115N");
        $excel->getActiveSheet()->setCellValue('AL3', "0002-100432");
        $excel->getActiveSheet()->setCellValue('AL4', "VISCO8300");
        ...
        $excel->getActiveSheet()->setCellValue('AP3', "0002-100436");
        $excel->getActiveSheet()->setCellValue('AP4', "ACE8381");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('BG3', "0000-100018");
        $excel->getActiveSheet()->setCellValue('BG4', "SEMEN PCC");
        ...
        $excel->getActiveSheet()->setCellValue('BJ4', "P121R");
        ...
        $excel->getActiveSheet()->setCellValue('BM3', "0002-100409");
        $excel->getActiveSheet()->setCellValue('BM4', "SK163");
        $excel->getActiveSheet()->setCellValue('BN3', "0002-100410");
        $excel->getActiveSheet()->setCellValue('BN4', "SIKATARD930");
        $excel->getActiveSheet()->setCellValue('BO3', "0002-100402");
        $excel->getActiveSheet()->setCellValue('BO4', "VIS 1003");
        $excel->getActiveSheet()->setCellValue('BP3', "0002-100407");
        $excel->getActiveSheet()->setCellValue('BP4', "VIS 1221R");
        $excel->getActiveSheet()->setCellValue('BQ3', "0002-100416");
        $excel->getActiveSheet()->setCellValue('BQ4', "VIS 7080P");
        $excel->getActiveSheet()->setCellValue('BR3', "0002-100010");
        $excel->getActiveSheet()->setCellValue('BR4', "SR3200");
        $excel->getActiveSheet()->setCellValue('BS3', "0002-100403");
        $excel->getActiveSheet()->setCellValue('BS4', "V3115N");
        $excel->getActiveSheet()->setCellValue('BT3', "0002-100432");
        $excel->getActiveSheet()->setCellValue('BT4', "VISCO8300");
        ...
        $excel->getActiveSheet()->setCellValue('BX3', "0002-100436");
        $excel->getActiveSheet()->setCellValue('BX4', "ACE8381");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('CM4', "SEMEN OPC TYPE 1");
        $excel->getActiveSheet()->setCellValue('CN3', "0000-100017");
        $excel->getActiveSheet()->setCellValue('CN4', "SEMEN OPC TYPE 2");
        $excel->getActiveSheet()->setCellValue('CO3', "0000-100018");
        $excel->getActiveSheet()->setCellValue('CO4', "SEMEN PCC");
        ...
        $excel->getActiveSheet()->setCellValue('CR4', "P121R");
        $excel->getActiveSheet()->setCellValue('CS3', "0002-100201");
        $excel->getActiveSheet()->setCellValue('CS4', "S523N");
        $excel->getActiveSheet()->setCellValue('CT3', "0002-100006");
        $excel->getActiveSheet()->setCellValue('CT4', "RT6P");
        $excel->getActiveSheet()->setCellValue('CU3', "0002-100409");
        $excel->getActiveSheet()->setCellValue('CU4', "SK163");
        $excel->getActiveSheet()->setCellValue('CV3', "0002-100410");
        $excel->getActiveSheet()->setCellValue('CV4', "SIKATARD930");
        $excel->getActiveSheet()->setCellValue('CW3', "0002-100402");
        $excel->getActiveSheet()->setCellValue('CW4', "VIS 1003");
        $excel->getActiveSheet()->setCellValue('CX3', "0002-100407");
        $excel->getActiveSheet()->setCellValue('CX4', "VIS 1221R");
        $excel->getActiveSheet()->setCellValue('CY3', "0002-100416");
        $excel->getActiveSheet()->setCellValue('CY4', "VIS 7080P");
        $excel->getActiveSheet()->setCellValue('CZ3', "0002-100010");
        $excel->getActiveSheet()->setCellValue('CZ4', "SR3200");
        $excel->getActiveSheet()->setCellValue('DA3', "0002-100403");
        $excel->getActiveSheet()->setCellValue('DA4', "V3115N");
        $excel->getActiveSheet()->setCellValue('DB3', "0002-100432");
        $excel->getActiveSheet()->setCellValue('DB4', "VISCO8300");
        ...
        $excel->getActiveSheet()->setCellValue('DF3', "0002-100436");
        $excel->getActiveSheet()->setCellValue('DF4', "ACE8381");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('DS4', "AGG5");
        $excel->getActiveSheet()->setCellValue('DT3', "0000-100039");
        $excel->getActiveSheet()->setCellValue('DT4', "AGG6");
        ...
        $excel->getActiveSheet()->setCellValue('EA3', "0000-100038");
        $excel->getActiveSheet()->setCellValue('EA4', "AGG5");
        $excel->getActiveSheet()->setCellValue('EB3', "0000-100039");
        $excel->getActiveSheet()->setCellValue('EB4', "AGG6");
        $excel->getActiveSheet()->setCellValue('EC3', "0000-100011");
        $excel->getActiveSheet()->setCellValue('EC4', "SEMEN OPC TYPE 1");
        $excel->getActiveSheet()->setCellValue('ED3', "0000-100017");
        $excel->getActiveSheet()->setCellValue('ED4', "SEMEN OPC TYPE 2");
        $excel->getActiveSheet()->setCellValue('EE3', "0000-100018");
        $excel->getActiveSheet()->setCellValue('EE4', "SEMEN PCC");
        ...
        $excel->getActiveSheet()->setCellValue('EH4', "P121R");
        $excel->getActiveSheet()->setCellValue('EI3', "0002-100201");
        $excel->getActiveSheet()->setCellValue('EI4', "S523N");
        $excel->getActiveSheet()->setCellValue('EJ3', "0002-100006");
        $excel->getActiveSheet()->setCellValue('EJ4', "RT6P");
        $excel->getActiveSheet()->setCellValue('EK3', "0002-100409");
        $excel->getActiveSheet()->setCellValue('EK4', "SK163");
        $excel->getActiveSheet()->setCellValue('EL3', "0002-100410");
        $excel->getActiveSheet()->setCellValue('EL4', "SIKATARD930");
        $excel->getActiveSheet()->setCellValue('EM3', "0002-100402");
        $excel->getActiveSheet()->setCellValue('EM4', "VIS 1003");
        $excel->getActiveSheet()->setCellValue('EN3', "0002-100407");
        $excel->getActiveSheet()->setCellValue('EN4', "VIS 1221R");
        $excel->getActiveSheet()->setCellValue('EO3', "0002-100416");
        $excel->getActiveSheet()->setCellValue('EO4', "VIS 7080P");
        $excel->getActiveSheet()->setCellValue('EP3', "0002-100010");
        $excel->getActiveSheet()->setCellValue('EP4', "SR3200");
        $excel->getActiveSheet()->setCellValue('EQ3', "0002-100403");
        $excel->getActiveSheet()->setCellValue('EQ4', "V3115N");
        $excel->getActiveSheet()->setCellValue('ER3', "0002-100432");
        $excel->getActiveSheet()->setCellValue('ER4', "VISCO8300");
        ...
        $excel->getActiveSheet()->setCellValue('EV3', "0002-100436");
        $excel->getActiveSheet()->setCellValue('EV4', "ACE8381");
...
//        $excel->getActiveSheet()->mergeCells('BV4:BV4');
        ...
        while($obj = $result->fetch_object()){
            ...
            if($result_total = $mysqli->query($query_select_total)){
                ...
                $act_total_agg6     = 0;
                $act_total_lms      = 0;
                $act_total_cementtp1   = 0;
                $act_total_cementtp2   = 0;
                $act_total_cementpcc   = 0;
                $act_total_fa       = 0;
                $act_total_water    = 0;
                ...
                $tar_total_agg6     = 0;
                $tar_total_lms      = 0;
                $tar_total_cementtp1   = 0;
                $tar_total_cementtp2   = 0;
                $tar_total_cementpcc   = 0;
                $tar_total_fa       = 0;
                $tar_total_water    = 0;
                ...
                $tar_total_flbpd19 = 0;
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    ...
                    elseif($obj_total->material_code == "0000-100092"){ //AGG3
                        ...
                        $excel->getActiveSheet()->setCellValue('BB5', $act_total_agg3);
                        $excel->getActiveSheet()->setCellValue('CJ5', $tar_total_agg3);
                    }
                     elseif($obj_total->material_code == "0000-100038"){ //AGG5 
                        $act_total_AGG5+=$obj_total->actual_qty;
                        $tar_total_AGG5+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BC5', $act_total_AGG5);
                        $excel->getActiveSheet()->setCellValue('CK5', $tar_total_AGG5);
                    } 
                     elseif($obj_total->material_code == "0000-100039"){ //AGG6
                        $act_total_agg6+=$obj_total->actual_qty;
                        $tar_total_agg6+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BD5', $act_total_agg6);
                        $excel->getActiveSheet()->setCellValue('CL5', $tar_total_agg6);
                    } 
                    elseif($obj_total->material_code == "0000-100011"){ //Cementtp1  
                        $act_total_cementtp1+=$obj_total->actual_qty;
                        $tar_total_cementtp1+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BE5', $act_total_cementtp1);
                        $excel->getActiveSheet()->setCellValue('CM5', $tar_total_cementtp1);
                    }
                    ...
                    elseif($obj_total->material_code == "0000-100018"){ //Cementpcc  
                        $act_total_cementpcc+=$obj_total->actual_qty;
                        $tar_total_cementpcc+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BG5', $act_total_cementpcc);
                        $excel->getActiveSheet()->setCellValue('CO5', $tar_total_cementpcc);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100001"){ //P 121 R 
                        ...
                        $excel->getActiveSheet()->setCellValue('BJ5', $act_total_P121R);
                        $excel->getActiveSheet()->setCellValue('CR5', $tar_total_P121R);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100409"){ //SK163
                        ...
                        $excel->getActiveSheet()->setCellValue('BM5', $act_total_sk163);
                        $excel->getActiveSheet()->setCellValue('CU5', $tar_total_sk163);
                    }
                    elseif($obj_total->material_code == "0002-100410"){ //SK930
                        $act_total_sk930+=$obj_total->actual_qty;
                        $tar_total_sk930+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BN5', $act_total_sk930);
                        $excel->getActiveSheet()->setCellValue('CV5', $tar_total_sk930);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100407"){ //VIS 1212R
                        ...
                        $excel->getActiveSheet()->setCellValue('BP5', $act_total_vis1212r);
                        $excel->getActiveSheet()->setCellValue('CX5', $tar_total_vis1212r);
                    }
                    elseif($obj_total->material_code == "0002-100416"){ //VIS 7080p 
                        $act_total_vis7080p+=$obj_total->actual_qty;
                        $tar_total_vis7080p+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BQ5', $act_total_vis7080p);
                        $excel->getActiveSheet()->setCellValue('CY5', $tar_total_vis7080p);
                    }
                    elseif($obj_total->material_code == "0002-100010"){ //SR 3200
                        $act_total_sr3200+=$obj_total->actual_qty;
                        $tar_total_sr3200+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BR5', $act_total_sr3200);
                        $excel->getActiveSheet()->setCellValue('CZ5', $tar_total_sr3200);
                    }    
                                   
                   
                    elseif($obj_total->material_code == "0002-100403"){ //V3115N 
                        $act_total_V3115N+=$obj_total->actual_qty;
                        $tar_total_V3115N+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BS5', $act_total_V3115N);
                        $excel->getActiveSheet()->setCellValue('DA5', $tar_total_V3115N);
                    }                        
                    elseif($obj_total->material_code == "0002-100432"){ //VISCO 8300 
                        $act_total_visco8300+=$obj_total->actual_qty;
                        $tar_total_visco8300+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BT5', $act_total_visco8300);
                        $excel->getActiveSheet()->setCellValue('DB5', $tar_total_visco8300);
                    }        
                    ...
                    elseif($obj_total->material_code == "0002-100436"){ //ACE 8381 
                        $act_total_ace8381+=$obj_total->actual_qty;
                        $tar_total_ace8381+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BX5', $act_total_ace8381);
                        $excel->getActiveSheet()->setCellValue('DF5', $tar_total_ace8381);
                    }    
            ...
            if($result_detail = $mysqli->query($query_select_detail)){
                ...
                while($obj_detail = $result_detail->fetch_object()){     
                    ...
                    elseif($obj_detail->material_code == "0000-100018"){ //Cementpcc
                        ...
                        $act_qty_cementpcc+=$obj_detail->actual_qty;
                        $tar_qty_cementpcc+=$obj_detail->target_qty;
                    }
                    ...
                    elseif($obj_detail->material_code == "0002-100436"){ //ACE 8381
                        ...
                        $act_qty_ace8381+=$obj_detail->actual_qty;
                        $tar_qty_ace8381+=$obj_detail->target_qty;
                    }  
            ...
            while($obj1 = $result_detail1->fetch_object()){     
                    ...
                    elseif($obj1->material_code == "0000-100092"){ //AGG3
                     ...
                     elseif($obj1->material_code == "0000-100038"){ //AGG5
                        $nor_qty_agg5+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("U".$row, $obj1->mix_qty);
                        
                       
                    }  
                     elseif($obj1->material_code == "0000-100039"){ //AGG6
                        $nor_qty_agg6+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("V".$row, $obj1->mix_qty);
                       
                       
                    }  
                    
                    elseif($obj1->material_code == "0000-100011"){ //Cementtp1 
                        $nor_qty_cementtp1+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0000-100018"){ //Cementpcc
                        $nor_qty_cementpcc+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0002-100001"){ //P 121 R 
                        $nor_qty_P121R+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0002-100409"){ //SK163
                        $nor_qty_sk163+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AE".$row, $obj1->mix_qty);
 
                    }
                    elseif($obj1->material_code == "0002-100410"){ //SK930
                        $nor_qty_sk930+=$obj1->mix_qty;
                    ...
                    elseif($obj1->material_code == "0002-100407"){ //VIS 1212R
                         $nor_qty_vis1212r+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AH".$row, $obj1->mix_qty);
  
                    }
                    elseif($obj1->material_code == "0002-100416"){ //VIS 7080p
                        $nor_qty_vis7080p+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AI".$row, $obj1->mix_qty);

                    }
                    elseif($obj1->material_code == "0002-100010"){ //SR 3200
                        $nor_qty_sr3200+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AJ".$row, $obj1->mix_qty);

                    } 

                    elseif($obj1->material_code == "0002-100403"){ //V3115N
                        $nor_qty_V3115N+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AK".$row, $obj1->mix_qty);

                    }                  
                    elseif($obj1->material_code == "0002-100432"){ //VISCO 8300
                        $nor_qty_visco8300+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AL".$row, $obj1->mix_qty);

                    }        
                    elseif($obj1->material_code == "0002-100015"){ //P83
                        $nor_qty_P83+=$obj1->mix_qty;
                        $excel->getActiveSheet()->setCellValue("AM5".$row, $obj1->mix_qty);
                    ...
                    elseif($obj1->material_code == "0002-100436"){ //ACE 8381
                        $nor_qty_ace8381+=$obj1->mix_qty;
               ...
               if($act_qty_fa+$act_qty_cementtp1==0){$fa_percentage=0;}
                ...
                if($act_qty_fa+$act_qty_cementpcc==0){$fa_percentage=0;}
                else{$fa_percentage = 100*($act_qty_fa/($act_qty_fa+$act_qty_cementpcc));}
                ...
                //var_AGG5
                 if($tar_qty_AGG5 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EA".$row, round($var_AGG5,2));
                }
                //var_AGG6
                 if($tar_qty_agg6 === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EB".$row, round($var_agg6,2));
                }
                ...
                $excel->getActiveSheet()->setCellValue("EC".$row, round($var_cementtp1,2));
                //sementtp2        
                ...
                //semenpcc
                if($tar_qty_cementpcc === 0){//$var_cement = 0;
                    $excel->getActiveSheet()->setCellValue("EE".$row,"");
                }
                else{$var_cementpcc = (($act_qty_cementpcc - $tar_qty_cementpcc)/($tar_qty_cementpcc))*100;}
                $excel->getActiveSheet()->setCellValue("EE".$row, round($var_cementpcc,2));
                ...
                if($tar_qty_P121R === 0){
                  //  $var_P121R = 0;
                    ...
                    $excel->getActiveSheet()->setCellValue("EH".$row, round($var_P121R,2));
                }
                if($tar_qty_s523n === 0){
                    //$var_s523n = 0;
                ...
                if($tar_qty_sk163 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EK".$row, round($var_sk163,2));
                }
                //sk930
                if($tar_qty_sk930 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EL".$row, round($var_sk930,2));
                }
                //vis1003
                ...
                if($tar_qty_vis1212r === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EN".$row, round($var_vis1212r,2));
                }
                ...
                if($tar_qty_vis7080p === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EO".$row, round($var_vis7080p,2));
                }
                //var_sr3200
                if($tar_qty_sr3200 === 0){ 
                    ...
                    $var_sr3200 = (($act_qty_sr3200 - $tar_qty_sr3200)/($tar_qty_sr3200))*100;
                    $excel->getActiveSheet()->setCellValue("EP".$row, round($var_sr3200,2));
                }
                 //var_vis3660lr
                 ...
                 if($tar_qty_V3115N === 0){ 
                    ...
                    $var_V3115N = (($act_qty_V3115N - $tar_qty_V3115N)/($tar_qty_V3115N))*100;
                    $excel->getActiveSheet()->setCellValue("EQ".$row, round($var_V3115N,2));
                }
                 //var_visco8300
                 if($tar_qty_visco8300 === 0){ 
                    $excel->getActiveSheet()->setCellValue("ER".$row,"");
                }
                else{
                    $var_visco8300 = (($act_qty_visco8300 - $tar_qty_visco8300)/($tar_qty_visco8300))*100;
                    $excel->getActiveSheet()->setCellValue("ER".$row, round($var_visco8300,2));
                }
                //var_P83
                if($tar_qty_P83 === 0){ 
                ...
                //var_ace8381
                if($tar_qty_ace8381 === 0){ 
                    $excel->getActiveSheet()->setCellValue("EP".$row,"");
                }
                else{
                    $var_ace8381 = (($act_qty_ace8381 - $tar_qty_ace8381)/($tar_qty_ace8381))*100;
                    $excel->getActiveSheet()->setCellValue("EP".$row, round($var_ace8381,2));
                }
                //var_genr8212
