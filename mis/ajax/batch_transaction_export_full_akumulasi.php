...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
        ...
        $excel->getActiveSheet()->setCellValue('AW3', "0002-100019");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('CF3', "0002-100019");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('CY3', "0002-100402");
        $excel->getActiveSheet()->setCellValue('CY4', "VIS 1003");
        ...
        $excel->getActiveSheet()->setCellValue('DO3', "0002-100019");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('EP3', "0002-100402");
        $excel->getActiveSheet()->setCellValue('EP4', "VIS 1003");
        ...
        $excel->getActiveSheet()->setCellValue('FF3', "0002-100019");
        ...
        while($obj = $result->fetch_object()){
                ...
                $tar_total_gencb10 = 0;
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    ...
                    elseif($obj_total->material_code == "0002-100402"){ //VIS 1003 
                        ...
                        $excel->getActiveSheet()->setCellValue('BP5', $act_total_vis1003);
                        $excel->getActiveSheet()->setCellValue('CY5', $tar_total_vis1003);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100019"){ //gencb10
            ...
            if($result_detail = $mysqli->query($query_select_detail)){
                ...
                while($obj_detail = $result_detail->fetch_object()){     
                    ...
                    elseif($obj_detail->material_code == "0002-100019"){ //gencb10
            ...
            while($obj1 = $result_detail1->fetch_object()){     
                    ...
                    elseif($obj1->material_code == "0002-100019"){ //gencb10
               ...
               if($act_qty_fa+$act_qty_semenA==0){$fa_percentage=0;}
                ...
                if($tar_qty_vis1003 === 0){
                    ...
                    $excel->getActiveSheet()->setCellValue("EP".$row, round($var_vis1003,2));
                }
