...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('CR3', "0002-100442");
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('EH3', "0002-100442");
        ...
        $excel->getActiveSheet()->setCellValue('ER4', "STONE DUST VAS");
        ...
        $excel->getActiveSheet()->setCellValue('EV4', "SBT PCA-8S");
