...
<div class="container-fluid">        
        <form action="ajax/tmp_batch_transaction.php" method="post" enctype="multipart/form-data" id="query" class="form-horizontal " role="form"> 
                    <div class="form-group">
                    <h1>Download Batch Transaction Data</h1>
                    </div>
	      	<div id="messages" class="">asasd</div>
                    <div class="component">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                 <input id="delvdate" value="<?php echo date('Ymd'); ?>" name="delvdate" type="text" placeholder="Delivery Date" class="form-control input-md">
                            </div>
                        </div>
                    </div>
                    <div class="component input">
                        ...
                        <div class="component text-center download">
                            <div class="form-group">                                
                                ...
                                <a class="btn btn-sm btn-default docket_m">Docket Tidak Normal&nbsp;<i class="fa fa-download"></i></a>
                                <a class="btn btn-sm btn-info mat_is_m">Mat Is Tidak Normal&nbsp;<i class="fa fa-download"></i></a>
                            </div>
                        </div>
                </form>
</div>
...
//            loading.show();
            ...
            $(".Full_n").click(function(e){
                e.preventDefault();
                var filter = $("#delvdate");
                window.open(base_url+"/ajax/batch_transaction_export_full.php?filter="+filter.val());  
                $(".Full_n").hide();
//                $(".mat_is_n").hide();
                //check_all_button();
            });
