...
//        $excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
       ...
       //0002-100010
        ...
        $excel->getActiveSheet()->setCellValue('DV3', "0000-100038");
        ...
        $excel->getActiveSheet()->mergeCells('DX2:FF2');
         $excel->getActiveSheet()->getStyle('DX2:FF2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('7DB6D5');   
        ...
        $excel->getActiveSheet()->setCellValue('DB4', "AGG2");
        $excel->getActiveSheet()->setCellValue('DC3', "0000-100092");
        $excel->getActiveSheet()->setCellValue('DC4', "AGG3");
        ...
        $excel->getActiveSheet()->setCellValue('EK3', "0002-100001");
        ...
        $excel->getActiveSheet()->setCellValue('EU4', "SAND DUST VAS");
        ...
        $excel->getActiveSheet()->setCellValue('EY4', "SBT PC8-8S");
...
//        $excel->getActiveSheet()->mergeCells('BV4:BV4');
        ...
        while($obj = $result->fetch_object()){
                 ...
                 while($obj_total = $result_total->fetch_object()){
                    ...
                    elseif($obj_total->material_code == "0000-100092"){ //AGG3
                     ...
                     elseif($obj_total->material_code == "0000-000029"){ //SEMEN B 
                        ...
                        $excel->getActiveSheet()->setCellValue('BD5', $act_total_semenB);
                        $excel->getActiveSheet()->setCellValue('CM5', $tar_total_semenB);
                    } 
                    ...
                    elseif($obj_total->material_code == "0000-100011"){ //Semen A  
                        ...
                        $excel->getActiveSheet()->setCellValue('BF5', $act_total_cementA);
                        $excel->getActiveSheet()->setCellValue('CO5', $tar_total_cementA);
                    }
                    ...
                    elseif($obj_total->material_code == "0002-100442"){ //flobasrPF34
                    ...
                    elseif($obj_total->material_code == "0000-100040"){ //Steel AGG1
                        $act_total_stlAGG1+=$obj_total->actual_qty;
                        $tar_total_stlAGG1+=$obj_total->target_qty;
                        $excel->getActiveSheet()->setCellValue('BL5', $act_total_stlAGG1);
                        $excel->getActiveSheet()->setCellValue('CU5', $tar_total_stlAGG1);
                    }
                    ...
                    elseif($obj_total->material_code == "0000-100064"){ //agg2 VAS
                    ...
                    elseif($obj_total->material_code == "0000-100066"){ //VSAND 
            ...
            if($result_detail = $mysqli->query($query_select_detail)){
                ...
                while($obj_detail = $result_detail->fetch_object()){     
                    ...
                    elseif($obj_detail->material_code == "0000-100040"){ //Steel AGG1
                        ...
                        $act_qty_stlAGG1+=$obj_detail->actual_qty;
                        $tar_qty_stlAGG1+=$obj_detail->target_qty;
                    }
                    ...
                    elseif($obj_detail->material_code == "0000-100066"){ //vsand
                        $excel->getActiveSheet()->setCellValue("BP".$row, $obj_detail->actual_qty);
            ...
            while($obj1 = $result_detail1->fetch_object()){     
                    ...
                    elseif($obj1->material_code == "0000-100066"){ //VSAND
               ...
               if($act_qty_fa+$act_qty_cementA==0){$fa_percentage=0;}
                ...
                if($tar_qty_stlAGG1 === 0){
                    //$var_stlAGG1 = 0;
                    $excel->getActiveSheet()->setCellValue("EI".$row,"");
                }
                else{
                    $var_stlAGG1 = (($act_qty_stlAGG1 - $tar_qty_stlAGG1)/($tar_qty_stlAGG1))*100;
                    $excel->getActiveSheet()->setCellValue("EI".$row, round($var_stlAGG1,2));
                }
                if ($tar_qty_rt6p === 0){
                    $excel->getActiveSheet()->setCellValue("EJ".$row,"");
                }else{
                    $var_rt6p = (($act_qty_rt6p - $tar_qty_rt6p)/($tar_qty_rt6p))*100;
                    $excel->getActiveSheet()->setCellValue("EJ".$row, round($var_rt6p,2));
                }
                //sbtconm
                ...
                if($tar_qty_vsand === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("ES".$row, round($var_vsand,2));
                }
                //var_SIKAMENT183
                ...
                if($tar_qty_get702 === 0){ 
                 ...
                 if($tar_qty_Bsand === 0){ 
                    ...
                    $excel->getActiveSheet()->setCellValue("EZ".$row, round($var_Bsand,2));
                }
                 ...
                 if($tar_qty_flbpd19 === 0){ 
                    ...
                    $var_gencb10 = (($act_qty_gencb10 - $tar_qty_gencb10)/($tar_qty_gencb0))*100;
                    $excel->getActiveSheet()->setCellValue("FB".$row, round($var_gencb10,2));
                }  
