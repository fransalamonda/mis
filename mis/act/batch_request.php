...
-->
<!doctype html>
<meta http-equiv=refresh content=90;url=list_delivery_schedule.php>
<head>
           ...
           ?>
                   <div class="component">
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="so_no" name="so_no" type="text" placeholder="SO Number" class="form-control input-md" autocomplete="off" value="<?=$row['so_no'];?>">
                        </div>
                    </div>
                </div>
                     <?php  ?>   
    ...
    <div  id="batch-add">
        <form action="ajax/batch_add.php" method="POST" id="detail" class="form-horizontal" role="form">
            <fieldset>
                ...
                <div class="component">
                    <div class="form-group">
                        <label class="col-md-4 control-label"style="color:red;""Font-Size:20px;"for="textinput">Vol Awal :</label>  
                        <div class="col-md-4">
                            <label class="control-label" id="delv_volume" for="textinput"></label>
                        </div>
                    </div>
                </div>
                <div class="component">
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="textinput">Total Vol TerLoad	:</label>  
                        <div class="col-md-4">
                            <label class="control-label" id="yesterday_b_request" for="textinput"></label>
                        </div>
                    </div>
                </div>
                <div class="component">
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="textinput">Vol Hari Ini :</label>  
                        <div class="col-md-4">
