...
if($object->group_id != 1 && $object->group_id !=2 && $object->group_id !=3 && $object->group_id !=4 && $object->group_id !=5 && $object->group_id !=6 && $object->group_id !=7){
                ...
                <div class="col-sm-12 colsm-offset-3">
                    ...
                    if(isset($_GET['filter']) && !empty($_GET['filter'])){
                        if(isset($_GET['time']) && !empty($_GET['time'])){
                            extract($_GET);
                            $q = "SELECT A.*, D.name_bom FROM `batch_transaction` A "
                                    . "LEFT JOIN `batch_transaction2` B ON A.`docket_no`=B.`docket_no` "
                                    . "LEFT JOIN `request` D ON A.`request_no` = D.`request_no`"
...
<!--                                                        <th>
                                              ...
                                              if($status_list == true){
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td><a href="" data-docket="<?php echo $row['docket_no'];?>" data-prod="<?php echo $row['product_code'];?>" class="view btn btn-xs btn-warning">View</a> <a href="batch_transaction_sosort.php?so_no=<?=$row['so_no'];?>" class=" btn btn-xs btn-success">Sort SO</a></td> 
                                                    </tr>
                                                        <?php
                                                        }
                                                ?>
