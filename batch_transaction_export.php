...
<html>
    <head>
            <title>Batch Transaction Export Full Report</title>
                ...
                <div class="row">
                    <div class="col-sm-12 colsm-offset-3">
                        <h1 class="page-header">
                            Export Full Batch Transaction

                            <?php
                             if(isset($_GET['filter1']) AND isset($_GET['filter2']) && !empty($_GET['filter1']) AND !empty($_GET['filter2'])){
                                 $ymd = DateTime::createFromFormat('Ymd', $_GET['filter1'])->format('Y M d');
                    ...
                    if(isset($_GET['filter1']) AND isset($_GET['filter2']) && !empty($_GET['filter1']) AND !empty($_GET['filter2'])){
                        if(isset($_GET['time']) && !empty($_GET['time'])){
                            ...
                            $q = "SELECT * FROM `batch_transaction` "
                                    . "WHERE `delv_date` BETWEEN '$filter1' AND '$filter2' "
                        ...
                        <div class="row">
                            <div class="col-lg-2 pull-left">
                                <form role="form" method="GET">
                                    ...
                                    <h4 ><font color="#1E90FF">FILTER DATA </font></h4>
                                    <br>
                                        <h5> Tanggal Awal </h5> 
                                       <div class="input-group col-md-12" >

                                           <input class="form-control" id="filter1" name="filter1" size="16" type="text" value="<?php echo date('Ymd'); ?>" placeholder="Pilih Tanggal" readonly="" />
                                         ...
                                         <h5> Tanggal Akhir </h5> 
                                          <div class="input-group col-md-12" >
                                            ...
                                            <input class="form-control" id="filter2" name="filter2" size="16" type="text" value="<?php echo date('Ymd'); ?>" placeholder="Pilih Tanggal" readonly="" />
...
<!--                                                    <tr>
                                ...
                                ?>
                                    ...
                                    <input type="hidden" name="filter1" value="<?php echo $_GET['filter1']; ?>" />
    ...
    <script>
    $(function() {
            $( "#filter1" ).datepicker({ dateFormat: 'yymmdd' });
            $( "#filter2" ).datepicker({ dateFormat: 'yymmdd' });
            $('#example').DataTable();
    });
    </script>
