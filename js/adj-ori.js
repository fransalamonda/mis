...
//                        $('#varian').html(obj.varian)
                        ...
                        $('select#sand').val('0');
                        $('select#water').val('0');
    //                    $('select#limestone').val('0');
    //                    $('select#p121r').val('0');
    //                    $('select#s523n').val('0');
                        $('select#rt6p').val('0');
    //                    $('select#sk163').val('0');
                        $('select#sikatard930').val('0');
                        $('select#semenc').val('0');
                        $('select#vis7080p').val('0');
						$('select#flbrpf34').val('0');
                        $('select#V3115N').val('0');
                        $('select#vis3660lr').val('0');
                        $('select#visco8300').val('0');
                        $('select#p83').val('0');
                        $('select#SIKAMENT183').val('0');
    //                    $('select#mast1007').val('0');
    //                    $('select#ace8381').val('0');
...
//                        $('#out_volume').html(obj.out_volume);
                        $('div#detail').hide();
                        $('select#fa').val('0');                                              
                        $('select#cementtp1').val('0');
                        $('select#cementtp2').val('0');
                        $('select#cementvas').val('0');
                        $('select#agg1').val('0');
                        $('select#agg2').val('0');
                        $('select#agg3').val('0');
                        $('select#msand').val('0');
                        $('select#sand').val('0');
                        $('select#sandvas').val('0');
                        $('select#water').val('0');
                        $('select#agg1vas').val('0');
                        $('select#agg2vas').val('0');
                        $('select#agg3vas').val('0');
                        $('select#stonedust').val('0');
                        $('select#stonedustvas').val('0');
                        $('select#stldust').val('0');                           
                        $('select#rt6p').val('0');
                        $('select#semenc').val('0');
                        $('select#flbrpf34').val('0');
                        $('select#vis3660lr').val('0');                       
                        $('select#gencb10').val('0');
                        $('select#sbtconm').val('0');
						$('select#sbtjm9').val('0');
                        $('select#sbtpca8s').val('0');
                        $('select#p83').val('0');
                        $('select#SIKAMENT183').val('0');                        
                        $('select#genr8212').val('0');
                        $('select#get702"').val('0');
